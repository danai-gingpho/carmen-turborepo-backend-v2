...
import {
  CreateRequestForPricingDetailCommentSchema,
  UpdateRequestForPricingDetailCommentSchema,
  AttachmentSchema,
...
export class RequestForPricingDetailCommentController {
   ...
   */
  @MessagePattern({
    cmd: 'request-for-pricing-detail-comment.find-by-id',
    service: 'request-for-pricing-detail-comment',
  })
  async findById(@Body() payload: MicroservicePayload): Promise<MicroserviceResponse> {
    ...
    await this.requestForPricingDetailCommentService.initializePrismaService(
      bu_code,
      user_id,
    );
    const auditContext = this.createAuditContext(payload);
    return runWithAuditContext(auditContext, () =>
      this.requestForPricingDetailCommentService.findById(id),
    );
  }
   ...
   */
  @MessagePattern({
    cmd: 'request-for-pricing-detail-comment.find-all-by-request-for-pricing-detail-id',
    service: 'request-for-pricing-detail-comment',
  })
  async findAllByRequestForPricingDetailId(@Body() payload: MicroservicePayload): Promise<MicroserviceResponse> {
    this.logger.debug(
      { function: 'findAllByRequestForPricingDetailId', payload },
      RequestForPricingDetailCommentController.name,
    );

    const { request_for_pricing_detail_id, user_id, bu_code, paginate } = payload;
    ...
    const auditContext = this.createAuditContext(payload);
    return runWithAuditContext(auditContext, () =>
      this.requestForPricingDetailCommentService.findAllByRequestForPricingDetailId(
   ...
   */
  @MessagePattern({
    cmd: 'request-for-pricing-detail-comment.create',
    service: 'request-for-pricing-detail-comment',
  })
  async create(@Body() payload: MicroservicePayload): Promise<MicroserviceResponse> {
    ...
    const parsedData = CreateRequestForPricingDetailCommentSchema.parse(data);

    const auditContext = this.createAuditContext(payload);
    return runWithAuditContext(auditContext, () =>
      this.requestForPricingDetailCommentService.create(parsedData),
    );
  }
   ...
   */
  @MessagePattern({
    cmd: 'request-for-pricing-detail-comment.update',
    service: 'request-for-pricing-detail-comment',
  })
  async update(@Body() payload: MicroservicePayload): Promise<MicroserviceResponse> {
    ...
    const parsedData = UpdateRequestForPricingDetailCommentSchema.parse(data);

    const auditContext = this.createAuditContext(payload);
    return runWithAuditContext(auditContext, () =>
      this.requestForPricingDetailCommentService.update(id, parsedData),
    );
  }
   ...
   */
  @MessagePattern({
    cmd: 'request-for-pricing-detail-comment.delete',
    service: 'request-for-pricing-detail-comment',
  })
  async delete(@Body() payload: MicroservicePayload): Promise<MicroserviceResponse> {
    ...
    const auditContext = this.createAuditContext(payload);
    return runWithAuditContext(auditContext, () =>
      this.requestForPricingDetailCommentService.delete(id),
    );
  }
   ...
   */
  @MessagePattern({
    cmd: 'request-for-pricing-detail-comment.add-attachment',
    service: 'request-for-pricing-detail-comment',
  })
  async addAttachment(@Body() payload: MicroservicePayload): Promise<MicroserviceResponse> {
    ...
    const auditContext = this.createAuditContext(payload);
    return runWithAuditContext(auditContext, () =>
      this.requestForPricingDetailCommentService.addAttachment(id, parsedAttachment),
    );
  }
   ...
   */
  @MessagePattern({
    cmd: 'request-for-pricing-detail-comment.remove-attachment',
    service: 'request-for-pricing-detail-comment',
  })
  async removeAttachment(@Body() payload: MicroservicePayload): Promise<MicroserviceResponse> {
    ...
    const auditContext = this.createAuditContext(payload);
    return runWithAuditContext(auditContext, () =>
      this.requestForPricingDetailCommentService.removeAttachment(id, fileToken),
    );
  }
}
