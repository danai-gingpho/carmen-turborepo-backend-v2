...
import {
  CreatePurchaseRequestDetailCommentSchema,
  UpdatePurchaseRequestDetailCommentSchema,
  AttachmentSchema,
...
export class PurchaseRequestDetailCommentController {
   ...
   */
  @MessagePattern({
    cmd: 'purchase-request-detail-comment.find-by-id',
    service: 'purchase-request-detail-comment',
  })
  async findById(@Body() payload: MicroservicePayload): Promise<MicroserviceResponse> {
    ...
    await this.purchaseRequestDetailCommentService.initializePrismaService(
      bu_code,
      user_id,
    );
    const auditContext = this.createAuditContext(payload);
    return runWithAuditContext(auditContext, () =>
      this.purchaseRequestDetailCommentService.findById(id),
    );
  }
   ...
   */
  @MessagePattern({
    cmd: 'purchase-request-detail-comment.find-all-by-purchase-request-detail-id',
    service: 'purchase-request-detail-comment',
  })
  async findAllByPurchaseRequestDetailId(@Body() payload: MicroservicePayload): Promise<MicroserviceResponse> {
    this.logger.debug(
      { function: 'findAllByPurchaseRequestDetailId', payload },
      PurchaseRequestDetailCommentController.name,
    );

    const { purchase_request_detail_id, user_id, bu_code, paginate } = payload;
    ...
    const auditContext = this.createAuditContext(payload);
    return runWithAuditContext(auditContext, () =>
      this.purchaseRequestDetailCommentService.findAllByPurchaseRequestDetailId(
   ...
   */
  @MessagePattern({
    cmd: 'purchase-request-detail-comment.create',
    service: 'purchase-request-detail-comment',
  })
  async create(@Body() payload: MicroservicePayload): Promise<MicroserviceResponse> {
    ...
    const parsedData = CreatePurchaseRequestDetailCommentSchema.parse(data);

    const auditContext = this.createAuditContext(payload);
    return runWithAuditContext(auditContext, () =>
      this.purchaseRequestDetailCommentService.create(parsedData),
    );
  }
   ...
   */
  @MessagePattern({
    cmd: 'purchase-request-detail-comment.update',
    service: 'purchase-request-detail-comment',
  })
  async update(@Body() payload: MicroservicePayload): Promise<MicroserviceResponse> {
    ...
    const parsedData = UpdatePurchaseRequestDetailCommentSchema.parse(data);

    const auditContext = this.createAuditContext(payload);
    return runWithAuditContext(auditContext, () =>
      this.purchaseRequestDetailCommentService.update(id, parsedData),
    );
  }
   ...
   */
  @MessagePattern({
    cmd: 'purchase-request-detail-comment.delete',
    service: 'purchase-request-detail-comment',
  })
  async delete(@Body() payload: MicroservicePayload): Promise<MicroserviceResponse> {
    ...
    const auditContext = this.createAuditContext(payload);
    return runWithAuditContext(auditContext, () =>
      this.purchaseRequestDetailCommentService.delete(id),
    );
  }
   ...
   */
  @MessagePattern({
    cmd: 'purchase-request-detail-comment.add-attachment',
    service: 'purchase-request-detail-comment',
  })
  async addAttachment(@Body() payload: MicroservicePayload): Promise<MicroserviceResponse> {
    ...
    const auditContext = this.createAuditContext(payload);
    return runWithAuditContext(auditContext, () =>
      this.purchaseRequestDetailCommentService.addAttachment(id, parsedAttachment),
    );
  }
   ...
   */
  @MessagePattern({
    cmd: 'purchase-request-detail-comment.remove-attachment',
    service: 'purchase-request-detail-comment',
  })
  async removeAttachment(@Body() payload: MicroservicePayload): Promise<MicroserviceResponse> {
    ...
    const auditContext = this.createAuditContext(payload);
    return runWithAuditContext(auditContext, () =>
      this.purchaseRequestDetailCommentService.removeAttachment(id, fileToken),
    );
  }
}
