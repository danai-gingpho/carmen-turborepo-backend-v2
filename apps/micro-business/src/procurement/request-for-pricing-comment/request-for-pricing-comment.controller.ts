...
import {
  CreateRequestForPricingCommentSchema,
  UpdateRequestForPricingCommentSchema,
  AttachmentSchema,
...
export class RequestForPricingCommentController {
   ...
   */
  @MessagePattern({
    cmd: 'request-for-pricing-comment.find-by-id',
    service: 'request-for-pricing-comment',
  })
  async findById(@Body() payload: MicroservicePayload): Promise<MicroserviceResponse> {
    ...
    await this.requestForPricingCommentService.initializePrismaService(
      bu_code,
      user_id,
    );
    const auditContext = this.createAuditContext(payload);
    return runWithAuditContext(auditContext, () =>
      this.requestForPricingCommentService.findById(id),
    );
  }
   ...
   */
  @MessagePattern({
    cmd: 'request-for-pricing-comment.find-all-by-request-for-pricing-id',
    service: 'request-for-pricing-comment',
  })
  async findAllByRequestForPricingId(@Body() payload: MicroservicePayload): Promise<MicroserviceResponse> {
    this.logger.debug(
      { function: 'findAllByRequestForPricingId', payload },
      RequestForPricingCommentController.name,
    );

    const { request_for_pricing_id, user_id, bu_code, paginate } = payload;
    ...
    const auditContext = this.createAuditContext(payload);
    return runWithAuditContext(auditContext, () =>
      this.requestForPricingCommentService.findAllByRequestForPricingId(
   ...
   */
  @MessagePattern({
    cmd: 'request-for-pricing-comment.create',
    service: 'request-for-pricing-comment',
  })
  async create(@Body() payload: MicroservicePayload): Promise<MicroserviceResponse> {
    ...
    const parsedData = CreateRequestForPricingCommentSchema.parse(data);

    const auditContext = this.createAuditContext(payload);
    return runWithAuditContext(auditContext, () =>
      this.requestForPricingCommentService.create(parsedData),
    );
  }
   ...
   */
  @MessagePattern({
    cmd: 'request-for-pricing-comment.update',
    service: 'request-for-pricing-comment',
  })
  async update(@Body() payload: MicroservicePayload): Promise<MicroserviceResponse> {
    ...
    const parsedData = UpdateRequestForPricingCommentSchema.parse(data);

    const auditContext = this.createAuditContext(payload);
    return runWithAuditContext(auditContext, () =>
      this.requestForPricingCommentService.update(id, parsedData),
    );
  }
   ...
   */
  @MessagePattern({
    cmd: 'request-for-pricing-comment.delete',
    service: 'request-for-pricing-comment',
  })
  async delete(@Body() payload: MicroservicePayload): Promise<MicroserviceResponse> {
    ...
    const auditContext = this.createAuditContext(payload);
    return runWithAuditContext(auditContext, () =>
      this.requestForPricingCommentService.delete(id),
    );
  }
   ...
   */
  @MessagePattern({
    cmd: 'request-for-pricing-comment.add-attachment',
    service: 'request-for-pricing-comment',
  })
  async addAttachment(@Body() payload: MicroservicePayload): Promise<MicroserviceResponse> {
    ...
    const auditContext = this.createAuditContext(payload);
    return runWithAuditContext(auditContext, () =>
      this.requestForPricingCommentService.addAttachment(id, parsedAttachment),
    );
  }
   ...
   */
  @MessagePattern({
    cmd: 'request-for-pricing-comment.remove-attachment',
    service: 'request-for-pricing-comment',
  })
  async removeAttachment(@Body() payload: MicroservicePayload): Promise<MicroserviceResponse> {
    ...
    const auditContext = this.createAuditContext(payload);
    return runWithAuditContext(auditContext, () =>
      this.requestForPricingCommentService.removeAttachment(id, fileToken),
    );
  }
}
