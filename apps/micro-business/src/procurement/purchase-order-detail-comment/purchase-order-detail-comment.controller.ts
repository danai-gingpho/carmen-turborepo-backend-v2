...
import {
  CreatePurchaseOrderDetailCommentSchema,
  UpdatePurchaseOrderDetailCommentSchema,
  AttachmentSchema,
...
export class PurchaseOrderDetailCommentController {
   ...
   */
  @MessagePattern({
    cmd: 'purchase-order-detail-comment.find-by-id',
    service: 'purchase-order-detail-comment',
  })
  async findById(@Body() payload: MicroservicePayload): Promise<MicroserviceResponse> {
    ...
    await this.purchaseOrderDetailCommentService.initializePrismaService(
      bu_code,
      user_id,
    );
    const auditContext = this.createAuditContext(payload);
    return runWithAuditContext(auditContext, () =>
      this.purchaseOrderDetailCommentService.findById(id),
    );
  }
   ...
   */
  @MessagePattern({
    cmd: 'purchase-order-detail-comment.find-all-by-purchase-order-detail-id',
    service: 'purchase-order-detail-comment',
  })
  async findAllByPurchaseOrderDetailId(@Body() payload: MicroservicePayload): Promise<MicroserviceResponse> {
    this.logger.debug(
      { function: 'findAllByPurchaseOrderDetailId', payload },
      PurchaseOrderDetailCommentController.name,
    );

    const { purchase_order_detail_id, user_id, bu_code, paginate } = payload;
    ...
    const auditContext = this.createAuditContext(payload);
    return runWithAuditContext(auditContext, () =>
      this.purchaseOrderDetailCommentService.findAllByPurchaseOrderDetailId(
   ...
   */
  @MessagePattern({
    cmd: 'purchase-order-detail-comment.create',
    service: 'purchase-order-detail-comment',
  })
  async create(@Body() payload: MicroservicePayload): Promise<MicroserviceResponse> {
    ...
    const parsedData = CreatePurchaseOrderDetailCommentSchema.parse(data);

    const auditContext = this.createAuditContext(payload);
    return runWithAuditContext(auditContext, () =>
      this.purchaseOrderDetailCommentService.create(parsedData),
    );
  }
   ...
   */
  @MessagePattern({
    cmd: 'purchase-order-detail-comment.update',
    service: 'purchase-order-detail-comment',
  })
  async update(@Body() payload: MicroservicePayload): Promise<MicroserviceResponse> {
    ...
    const parsedData = UpdatePurchaseOrderDetailCommentSchema.parse(data);

    const auditContext = this.createAuditContext(payload);
    return runWithAuditContext(auditContext, () =>
      this.purchaseOrderDetailCommentService.update(id, parsedData),
    );
  }
   ...
   */
  @MessagePattern({
    cmd: 'purchase-order-detail-comment.delete',
    service: 'purchase-order-detail-comment',
  })
  async delete(@Body() payload: MicroservicePayload): Promise<MicroserviceResponse> {
    ...
    const auditContext = this.createAuditContext(payload);
    return runWithAuditContext(auditContext, () =>
      this.purchaseOrderDetailCommentService.delete(id),
    );
  }
   ...
   */
  @MessagePattern({
    cmd: 'purchase-order-detail-comment.add-attachment',
    service: 'purchase-order-detail-comment',
  })
  async addAttachment(@Body() payload: MicroservicePayload): Promise<MicroserviceResponse> {
    ...
    const auditContext = this.createAuditContext(payload);
    return runWithAuditContext(auditContext, () =>
      this.purchaseOrderDetailCommentService.addAttachment(id, parsedAttachment),
    );
  }
   ...
   */
  @MessagePattern({
    cmd: 'purchase-order-detail-comment.remove-attachment',
    service: 'purchase-order-detail-comment',
  })
  async removeAttachment(@Body() payload: MicroservicePayload): Promise<MicroserviceResponse> {
    ...
    const auditContext = this.createAuditContext(payload);
    return runWithAuditContext(auditContext, () =>
      this.purchaseOrderDetailCommentService.removeAttachment(id, fileToken),
    );
  }
}
