...
import {
  CreateExtraCostDetailCommentSchema,
  UpdateExtraCostDetailCommentSchema,
  AttachmentSchema,
...
export class ExtraCostDetailCommentController {
   ...
   */
  @MessagePattern({
    cmd: 'extra-cost-detail-comment.find-by-id',
    service: 'extra-cost-detail-comment',
  })
  async findById(@Body() payload: MicroservicePayload): Promise<MicroserviceResponse> {
    ...
    await this.extraCostDetailCommentService.initializePrismaService(
      bu_code,
      user_id,
    );
    const auditContext = this.createAuditContext(payload);
    return runWithAuditContext(auditContext, () =>
      this.extraCostDetailCommentService.findById(id),
    );
  }
   ...
   */
  @MessagePattern({
    cmd: 'extra-cost-detail-comment.find-all-by-extra-cost-detail-id',
    service: 'extra-cost-detail-comment',
  })
  async findAllByExtraCostDetailId(@Body() payload: MicroservicePayload): Promise<MicroserviceResponse> {
    this.logger.debug(
      { function: 'findAllByExtraCostDetailId', payload },
      ExtraCostDetailCommentController.name,
    );

    const { extra_cost_detail_id, user_id, bu_code, paginate } = payload;
    ...
    const auditContext = this.createAuditContext(payload);
    return runWithAuditContext(auditContext, () =>
      this.extraCostDetailCommentService.findAllByExtraCostDetailId(
   ...
   */
  @MessagePattern({
    cmd: 'extra-cost-detail-comment.create',
    service: 'extra-cost-detail-comment',
  })
  async create(@Body() payload: MicroservicePayload): Promise<MicroserviceResponse> {
    ...
    const parsedData = CreateExtraCostDetailCommentSchema.parse(data);

    const auditContext = this.createAuditContext(payload);
    return runWithAuditContext(auditContext, () =>
      this.extraCostDetailCommentService.create(parsedData),
    );
  }
   ...
   */
  @MessagePattern({
    cmd: 'extra-cost-detail-comment.update',
    service: 'extra-cost-detail-comment',
  })
  async update(@Body() payload: MicroservicePayload): Promise<MicroserviceResponse> {
    ...
    const parsedData = UpdateExtraCostDetailCommentSchema.parse(data);

    const auditContext = this.createAuditContext(payload);
    return runWithAuditContext(auditContext, () =>
      this.extraCostDetailCommentService.update(id, parsedData),
    );
  }
   ...
   */
  @MessagePattern({
    cmd: 'extra-cost-detail-comment.delete',
    service: 'extra-cost-detail-comment',
  })
  async delete(@Body() payload: MicroservicePayload): Promise<MicroserviceResponse> {
    ...
    const auditContext = this.createAuditContext(payload);
    return runWithAuditContext(auditContext, () =>
      this.extraCostDetailCommentService.delete(id),
    );
  }
   ...
   */
  @MessagePattern({
    cmd: 'extra-cost-detail-comment.add-attachment',
    service: 'extra-cost-detail-comment',
  })
  async addAttachment(@Body() payload: MicroservicePayload): Promise<MicroserviceResponse> {
    ...
    const auditContext = this.createAuditContext(payload);
    return runWithAuditContext(auditContext, () =>
      this.extraCostDetailCommentService.addAttachment(id, parsedAttachment),
    );
  }
   ...
   */
  @MessagePattern({
    cmd: 'extra-cost-detail-comment.remove-attachment',
    service: 'extra-cost-detail-comment',
  })
  async removeAttachment(@Body() payload: MicroservicePayload): Promise<MicroserviceResponse> {
    ...
    const auditContext = this.createAuditContext(payload);
    return runWithAuditContext(auditContext, () =>
      this.extraCostDetailCommentService.removeAttachment(id, fileToken),
    );
  }
}
