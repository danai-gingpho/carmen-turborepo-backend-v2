...
import {
  CreateSpotCheckDetailCommentSchema,
  UpdateSpotCheckDetailCommentSchema,
  AttachmentSchema,
...
export class SpotCheckDetailCommentController {
   ...
   */
  @MessagePattern({
    cmd: 'spot-check-detail-comment.find-by-id',
    service: 'spot-check-detail-comment',
  })
  async findById(@Body() payload: MicroservicePayload): Promise<MicroserviceResponse> {
    ...
    await this.spotCheckDetailCommentService.initializePrismaService(
      bu_code,
      user_id,
    );
    const auditContext = this.createAuditContext(payload);
    return runWithAuditContext(auditContext, () =>
      this.spotCheckDetailCommentService.findById(id),
    );
  }
   ...
   */
  @MessagePattern({
    cmd: 'spot-check-detail-comment.find-all-by-spot-check-detail-id',
    service: 'spot-check-detail-comment',
  })
  async findAllBySpotCheckDetailId(@Body() payload: MicroservicePayload): Promise<MicroserviceResponse> {
    this.logger.debug(
      { function: 'findAllBySpotCheckDetailId', payload },
      SpotCheckDetailCommentController.name,
    );

    const { spot_check_detail_id, user_id, bu_code, paginate } = payload;
    ...
    const auditContext = this.createAuditContext(payload);
    return runWithAuditContext(auditContext, () =>
      this.spotCheckDetailCommentService.findAllBySpotCheckDetailId(
   ...
   */
  @MessagePattern({
    cmd: 'spot-check-detail-comment.create',
    service: 'spot-check-detail-comment',
  })
  async create(@Body() payload: MicroservicePayload): Promise<MicroserviceResponse> {
    ...
    const parsedData = CreateSpotCheckDetailCommentSchema.parse(data);

    const auditContext = this.createAuditContext(payload);
    return runWithAuditContext(auditContext, () =>
      this.spotCheckDetailCommentService.create(parsedData),
    );
  }
   ...
   */
  @MessagePattern({
    cmd: 'spot-check-detail-comment.update',
    service: 'spot-check-detail-comment',
  })
  async update(@Body() payload: MicroservicePayload): Promise<MicroserviceResponse> {
    ...
    const parsedData = UpdateSpotCheckDetailCommentSchema.parse(data);

    const auditContext = this.createAuditContext(payload);
    return runWithAuditContext(auditContext, () =>
      this.spotCheckDetailCommentService.update(id, parsedData),
    );
  }
   ...
   */
  @MessagePattern({
    cmd: 'spot-check-detail-comment.delete',
    service: 'spot-check-detail-comment',
  })
  async delete(@Body() payload: MicroservicePayload): Promise<MicroserviceResponse> {
    ...
    const auditContext = this.createAuditContext(payload);
    return runWithAuditContext(auditContext, () =>
      this.spotCheckDetailCommentService.delete(id),
    );
  }
   ...
   */
  @MessagePattern({
    cmd: 'spot-check-detail-comment.add-attachment',
    service: 'spot-check-detail-comment',
  })
  async addAttachment(@Body() payload: MicroservicePayload): Promise<MicroserviceResponse> {
    ...
    const auditContext = this.createAuditContext(payload);
    return runWithAuditContext(auditContext, () =>
      this.spotCheckDetailCommentService.addAttachment(id, parsedAttachment),
    );
  }
   ...
   */
  @MessagePattern({
    cmd: 'spot-check-detail-comment.remove-attachment',
    service: 'spot-check-detail-comment',
  })
  async removeAttachment(@Body() payload: MicroservicePayload): Promise<MicroserviceResponse> {
    ...
    const auditContext = this.createAuditContext(payload);
    return runWithAuditContext(auditContext, () =>
      this.spotCheckDetailCommentService.removeAttachment(id, fileToken),
    );
  }
}
