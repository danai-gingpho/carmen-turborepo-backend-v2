...
import {
  CreateStockInDetailCommentSchema,
  UpdateStockInDetailCommentSchema,
  AttachmentSchema,
...
export class StockInDetailCommentController {
   ...
   */
  @MessagePattern({
    cmd: 'stock-in-detail-comment.find-by-id',
    service: 'stock-in-detail-comment',
  })
  async findById(@Body() payload: MicroservicePayload): Promise<MicroserviceResponse> {
    ...
    await this.stockInDetailCommentService.initializePrismaService(
      bu_code,
      user_id,
    );
    const auditContext = this.createAuditContext(payload);
    return runWithAuditContext(auditContext, () =>
      this.stockInDetailCommentService.findById(id),
    );
  }
   ...
   */
  @MessagePattern({
    cmd: 'stock-in-detail-comment.find-all-by-stock-in-detail-id',
    service: 'stock-in-detail-comment',
  })
  async findAllByStockInDetailId(@Body() payload: MicroservicePayload): Promise<MicroserviceResponse> {
    this.logger.debug(
      { function: 'findAllByStockInDetailId', payload },
      StockInDetailCommentController.name,
    );

    const { stock_in_detail_id, user_id, bu_code, paginate } = payload;
    ...
    const auditContext = this.createAuditContext(payload);
    return runWithAuditContext(auditContext, () =>
      this.stockInDetailCommentService.findAllByStockInDetailId(
        stock_in_detail_id,
        paginate,
      ),
    );
   ...
   */
  @MessagePattern({
    cmd: 'stock-in-detail-comment.create',
    service: 'stock-in-detail-comment',
  })
  async create(@Body() payload: MicroservicePayload): Promise<MicroserviceResponse> {
    ...
    const parsedData = CreateStockInDetailCommentSchema.parse(data);

    const auditContext = this.createAuditContext(payload);
    return runWithAuditContext(auditContext, () =>
      this.stockInDetailCommentService.create(parsedData),
    );
  }
   ...
   */
  @MessagePattern({
    cmd: 'stock-in-detail-comment.update',
    service: 'stock-in-detail-comment',
  })
  async update(@Body() payload: MicroservicePayload): Promise<MicroserviceResponse> {
    ...
    const parsedData = UpdateStockInDetailCommentSchema.parse(data);

    const auditContext = this.createAuditContext(payload);
    return runWithAuditContext(auditContext, () =>
      this.stockInDetailCommentService.update(id, parsedData),
    );
  }
   ...
   */
  @MessagePattern({
    cmd: 'stock-in-detail-comment.delete',
    service: 'stock-in-detail-comment',
  })
  async delete(@Body() payload: MicroservicePayload): Promise<MicroserviceResponse> {
    ...
    const auditContext = this.createAuditContext(payload);
    return runWithAuditContext(auditContext, () =>
      this.stockInDetailCommentService.delete(id),
    );
  }
   ...
   */
  @MessagePattern({
    cmd: 'stock-in-detail-comment.add-attachment',
    service: 'stock-in-detail-comment',
  })
  async addAttachment(@Body() payload: MicroservicePayload): Promise<MicroserviceResponse> {
    ...
    const auditContext = this.createAuditContext(payload);
    return runWithAuditContext(auditContext, () =>
      this.stockInDetailCommentService.addAttachment(id, parsedAttachment),
    );
  }
   ...
   */
  @MessagePattern({
    cmd: 'stock-in-detail-comment.remove-attachment',
    service: 'stock-in-detail-comment',
  })
  async removeAttachment(@Body() payload: MicroservicePayload): Promise<MicroserviceResponse> {
    ...
    const auditContext = this.createAuditContext(payload);
    return runWithAuditContext(auditContext, () =>
      this.stockInDetailCommentService.removeAttachment(id, fileToken),
    );
  }
}
