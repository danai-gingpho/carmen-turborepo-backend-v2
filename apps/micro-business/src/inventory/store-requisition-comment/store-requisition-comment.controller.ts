...
import {
  CreateStoreRequisitionCommentSchema,
  UpdateStoreRequisitionCommentSchema,
  AttachmentSchema,
...
export class StoreRequisitionCommentController {
   ...
   */
  @MessagePattern({
    cmd: 'store-requisition-comment.find-by-id',
    service: 'store-requisition-comment',
  })
  async findById(@Body() payload: MicroservicePayload): Promise<MicroserviceResponse> {
    ...
    await this.storeRequisitionCommentService.initializePrismaService(
      bu_code,
      user_id,
    );
    const auditContext = this.createAuditContext(payload);
    return runWithAuditContext(auditContext, () =>
      this.storeRequisitionCommentService.findById(id),
    );
  }
   ...
   */
  @MessagePattern({
    cmd: 'store-requisition-comment.find-all-by-store-requisition-id',
    service: 'store-requisition-comment',
  })
  async findAllByStoreRequisitionId(@Body() payload: MicroservicePayload): Promise<MicroserviceResponse> {
    this.logger.debug(
      { function: 'findAllByStoreRequisitionId', payload },
      StoreRequisitionCommentController.name,
    );

    const { store_requisition_id, user_id, bu_code, paginate } = payload;
    ...
    const auditContext = this.createAuditContext(payload);
    return runWithAuditContext(auditContext, () =>
      this.storeRequisitionCommentService.findAllByStoreRequisitionId(
   ...
   */
  @MessagePattern({
    cmd: 'store-requisition-comment.create',
    service: 'store-requisition-comment',
  })
  async create(@Body() payload: MicroservicePayload): Promise<MicroserviceResponse> {
    ...
    const parsedData = CreateStoreRequisitionCommentSchema.parse(data);

    const auditContext = this.createAuditContext(payload);
    return runWithAuditContext(auditContext, () =>
      this.storeRequisitionCommentService.create(parsedData),
    );
  }
   ...
   */
  @MessagePattern({
    cmd: 'store-requisition-comment.update',
    service: 'store-requisition-comment',
  })
  async update(@Body() payload: MicroservicePayload): Promise<MicroserviceResponse> {
    ...
    const parsedData = UpdateStoreRequisitionCommentSchema.parse(data);

    const auditContext = this.createAuditContext(payload);
    return runWithAuditContext(auditContext, () =>
      this.storeRequisitionCommentService.update(id, parsedData),
    );
  }
   ...
   */
  @MessagePattern({
    cmd: 'store-requisition-comment.delete',
    service: 'store-requisition-comment',
  })
  async delete(@Body() payload: MicroservicePayload): Promise<MicroserviceResponse> {
    ...
    const auditContext = this.createAuditContext(payload);
    return runWithAuditContext(auditContext, () =>
      this.storeRequisitionCommentService.delete(id),
    );
  }
   ...
   */
  @MessagePattern({
    cmd: 'store-requisition-comment.add-attachment',
    service: 'store-requisition-comment',
  })
  async addAttachment(@Body() payload: MicroservicePayload): Promise<MicroserviceResponse> {
    ...
    const auditContext = this.createAuditContext(payload);
    return runWithAuditContext(auditContext, () =>
      this.storeRequisitionCommentService.addAttachment(id, parsedAttachment),
    );
  }
   ...
   */
  @MessagePattern({
    cmd: 'store-requisition-comment.remove-attachment',
    service: 'store-requisition-comment',
  })
  async removeAttachment(@Body() payload: MicroservicePayload): Promise<MicroserviceResponse> {
    ...
    const auditContext = this.createAuditContext(payload);
    return runWithAuditContext(auditContext, () =>
      this.storeRequisitionCommentService.removeAttachment(id, fileToken),
    );
  }
}
