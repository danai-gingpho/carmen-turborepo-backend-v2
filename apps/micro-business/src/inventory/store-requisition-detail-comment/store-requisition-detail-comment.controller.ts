...
import {
  CreateStoreRequisitionDetailCommentSchema,
  UpdateStoreRequisitionDetailCommentSchema,
  AttachmentSchema,
...
export class StoreRequisitionDetailCommentController {
   ...
   */
  @MessagePattern({
    cmd: 'store-requisition-detail-comment.find-by-id',
    service: 'store-requisition-detail-comment',
  })
  async findById(@Body() payload: MicroservicePayload): Promise<MicroserviceResponse> {
    ...
    await this.storeRequisitionDetailCommentService.initializePrismaService(
      bu_code,
      user_id,
    );
    const auditContext = this.createAuditContext(payload);
    return runWithAuditContext(auditContext, () =>
      this.storeRequisitionDetailCommentService.findById(id),
    );
  }
   ...
   */
  @MessagePattern({
    cmd: 'store-requisition-detail-comment.find-all-by-store-requisition-detail-id',
    service: 'store-requisition-detail-comment',
  })
  async findAllByStoreRequisitionDetailId(@Body() payload: MicroservicePayload): Promise<MicroserviceResponse> {
    this.logger.debug(
      { function: 'findAllByStoreRequisitionDetailId', payload },
      StoreRequisitionDetailCommentController.name,
    );

    const { store_requisition_detail_id, user_id, bu_code, paginate } = payload;
    ...
    const auditContext = this.createAuditContext(payload);
    return runWithAuditContext(auditContext, () =>
      this.storeRequisitionDetailCommentService.findAllByStoreRequisitionDetailId(
   ...
   */
  @MessagePattern({
    cmd: 'store-requisition-detail-comment.create',
    service: 'store-requisition-detail-comment',
  })
  async create(@Body() payload: MicroservicePayload): Promise<MicroserviceResponse> {
    ...
    const parsedData = CreateStoreRequisitionDetailCommentSchema.parse(data);

    const auditContext = this.createAuditContext(payload);
    return runWithAuditContext(auditContext, () =>
      this.storeRequisitionDetailCommentService.create(parsedData),
    );
  }
   ...
   */
  @MessagePattern({
    cmd: 'store-requisition-detail-comment.update',
    service: 'store-requisition-detail-comment',
  })
  async update(@Body() payload: MicroservicePayload): Promise<MicroserviceResponse> {
    ...
    const parsedData = UpdateStoreRequisitionDetailCommentSchema.parse(data);

    const auditContext = this.createAuditContext(payload);
    return runWithAuditContext(auditContext, () =>
      this.storeRequisitionDetailCommentService.update(id, parsedData),
    );
  }
   ...
   */
  @MessagePattern({
    cmd: 'store-requisition-detail-comment.delete',
    service: 'store-requisition-detail-comment',
  })
  async delete(@Body() payload: MicroservicePayload): Promise<MicroserviceResponse> {
    ...
    const auditContext = this.createAuditContext(payload);
    return runWithAuditContext(auditContext, () =>
      this.storeRequisitionDetailCommentService.delete(id),
    );
  }
   ...
   */
  @MessagePattern({
    cmd: 'store-requisition-detail-comment.add-attachment',
    service: 'store-requisition-detail-comment',
  })
  async addAttachment(@Body() payload: MicroservicePayload): Promise<MicroserviceResponse> {
    ...
    const auditContext = this.createAuditContext(payload);
    return runWithAuditContext(auditContext, () =>
      this.storeRequisitionDetailCommentService.addAttachment(id, parsedAttachment),
    );
  }
   ...
   */
  @MessagePattern({
    cmd: 'store-requisition-detail-comment.remove-attachment',
    service: 'store-requisition-detail-comment',
  })
  async removeAttachment(@Body() payload: MicroservicePayload): Promise<MicroserviceResponse> {
    ...
    const auditContext = this.createAuditContext(payload);
    return runWithAuditContext(auditContext, () =>
      this.storeRequisitionDetailCommentService.removeAttachment(id, fileToken),
    );
  }
}
