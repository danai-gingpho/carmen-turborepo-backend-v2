...
import {
  CreateStockOutDetailCommentSchema,
  UpdateStockOutDetailCommentSchema,
  AttachmentSchema,
...
export class StockOutDetailCommentController {
   ...
   */
  @MessagePattern({
    cmd: 'stock-out-detail-comment.find-by-id',
    service: 'stock-out-detail-comment',
  })
  async findById(@Body() payload: MicroservicePayload): Promise<MicroserviceResponse> {
    ...
    await this.stockOutDetailCommentService.initializePrismaService(
      bu_code,
      user_id,
    );
    const auditContext = this.createAuditContext(payload);
    return runWithAuditContext(auditContext, () =>
      this.stockOutDetailCommentService.findById(id),
    );
  }
   ...
   */
  @MessagePattern({
    cmd: 'stock-out-detail-comment.find-all-by-stock-out-detail-id',
    service: 'stock-out-detail-comment',
  })
  async findAllByStockOutDetailId(@Body() payload: MicroservicePayload): Promise<MicroserviceResponse> {
    this.logger.debug(
      { function: 'findAllByStockOutDetailId', payload },
      StockOutDetailCommentController.name,
    );

    const { stock_out_detail_id, user_id, bu_code, paginate } = payload;
    ...
    const auditContext = this.createAuditContext(payload);
    return runWithAuditContext(auditContext, () =>
      this.stockOutDetailCommentService.findAllByStockOutDetailId(
        stock_out_detail_id,
        paginate,
      ),
    );
   ...
   */
  @MessagePattern({
    cmd: 'stock-out-detail-comment.create',
    service: 'stock-out-detail-comment',
  })
  async create(@Body() payload: MicroservicePayload): Promise<MicroserviceResponse> {
    ...
    const parsedData = CreateStockOutDetailCommentSchema.parse(data);

    const auditContext = this.createAuditContext(payload);
    return runWithAuditContext(auditContext, () =>
      this.stockOutDetailCommentService.create(parsedData),
    );
  }
   ...
   */
  @MessagePattern({
    cmd: 'stock-out-detail-comment.update',
    service: 'stock-out-detail-comment',
  })
  async update(@Body() payload: MicroservicePayload): Promise<MicroserviceResponse> {
    ...
    const parsedData = UpdateStockOutDetailCommentSchema.parse(data);

    const auditContext = this.createAuditContext(payload);
    return runWithAuditContext(auditContext, () =>
      this.stockOutDetailCommentService.update(id, parsedData),
    );
  }
   ...
   */
  @MessagePattern({
    cmd: 'stock-out-detail-comment.delete',
    service: 'stock-out-detail-comment',
  })
  async delete(@Body() payload: MicroservicePayload): Promise<MicroserviceResponse> {
    ...
    const auditContext = this.createAuditContext(payload);
    return runWithAuditContext(auditContext, () =>
      this.stockOutDetailCommentService.delete(id),
    );
  }
   ...
   */
  @MessagePattern({
    cmd: 'stock-out-detail-comment.add-attachment',
    service: 'stock-out-detail-comment',
  })
  async addAttachment(@Body() payload: MicroservicePayload): Promise<MicroserviceResponse> {
    ...
    const auditContext = this.createAuditContext(payload);
    return runWithAuditContext(auditContext, () =>
      this.stockOutDetailCommentService.addAttachment(id, parsedAttachment),
    );
  }
   ...
   */
  @MessagePattern({
    cmd: 'stock-out-detail-comment.remove-attachment',
    service: 'stock-out-detail-comment',
  })
  async removeAttachment(@Body() payload: MicroservicePayload): Promise<MicroserviceResponse> {
    ...
    const auditContext = this.createAuditContext(payload);
    return runWithAuditContext(auditContext, () =>
      this.stockOutDetailCommentService.removeAttachment(id, fileToken),
    );
  }
}
