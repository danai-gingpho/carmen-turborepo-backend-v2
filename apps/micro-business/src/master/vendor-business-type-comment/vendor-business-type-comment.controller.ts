...
import {
  CreateVendorBusinessTypeCommentSchema,
  UpdateVendorBusinessTypeCommentSchema,
  AttachmentSchema,
} from './dto/vendor-business-type-comment.dto';
...
export class VendorBusinessTypeCommentController {
  private readonly logger: BackendLogger = new BackendLogger(
    VendorBusinessTypeCommentController.name,
  );

  constructor(
    private readonly vendorBusinessTypeCommentService: VendorBusinessTypeCommentService,
  ) {}
   ...
   */
  @MessagePattern({
    cmd: 'vendor-business-type-comment.find-by-id',
    service: 'vendor-business-type-comment',
  })
  async findById(@Body() payload: MicroservicePayload): Promise<MicroserviceResponse> {
    ...
    await this.vendorBusinessTypeCommentService.initializePrismaService(
      bu_code,
      user_id,
    );
    const auditContext = this.createAuditContext(payload);
    return runWithAuditContext(auditContext, () =>
      this.vendorBusinessTypeCommentService.findById(id),
    );
  }
   ...
   */
  @MessagePattern({
    cmd: 'vendor-business-type-comment.find-all-by-vendor-business-type-id',
    service: 'vendor-business-type-comment',
  })
  async findAllByVendorBusinessTypeId(@Body() payload: MicroservicePayload): Promise<MicroserviceResponse> {
    this.logger.debug(
      { function: 'findAllByVendorBusinessTypeId', payload },
      VendorBusinessTypeCommentController.name,
    );

    const { vendor_business_type_id, user_id, bu_code, paginate } = payload;
    ...
    const auditContext = this.createAuditContext(payload);
    return runWithAuditContext(auditContext, () =>
      this.vendorBusinessTypeCommentService.findAllByVendorBusinessTypeId(
   ...
   */
  @MessagePattern({
    cmd: 'vendor-business-type-comment.create',
    service: 'vendor-business-type-comment',
  })
  async create(@Body() payload: MicroservicePayload): Promise<MicroserviceResponse> {
    ...
    const parsedData = CreateVendorBusinessTypeCommentSchema.parse(data);

    const auditContext = this.createAuditContext(payload);
    return runWithAuditContext(auditContext, () =>
      this.vendorBusinessTypeCommentService.create(parsedData),
    );
  }
   ...
   */
  @MessagePattern({
    cmd: 'vendor-business-type-comment.update',
    service: 'vendor-business-type-comment',
  })
  async update(@Body() payload: MicroservicePayload): Promise<MicroserviceResponse> {
    ...
    const parsedData = UpdateVendorBusinessTypeCommentSchema.parse(data);

    const auditContext = this.createAuditContext(payload);
    return runWithAuditContext(auditContext, () =>
      this.vendorBusinessTypeCommentService.update(id, parsedData),
    );
  }
   ...
   */
  @MessagePattern({
    cmd: 'vendor-business-type-comment.delete',
    service: 'vendor-business-type-comment',
  })
  async delete(@Body() payload: MicroservicePayload): Promise<MicroserviceResponse> {
    ...
    const auditContext = this.createAuditContext(payload);
    return runWithAuditContext(auditContext, () =>
      this.vendorBusinessTypeCommentService.delete(id),
    );
  }
   ...
   */
  @MessagePattern({
    cmd: 'vendor-business-type-comment.add-attachment',
    service: 'vendor-business-type-comment',
  })
  async addAttachment(@Body() payload: MicroservicePayload): Promise<MicroserviceResponse> {
    ...
    const auditContext = this.createAuditContext(payload);
    return runWithAuditContext(auditContext, () =>
      this.vendorBusinessTypeCommentService.addAttachment(id, parsedAttachment),
    );
  }
   ...
   */
  @MessagePattern({
    cmd: 'vendor-business-type-comment.remove-attachment',
    service: 'vendor-business-type-comment',
  })
  async removeAttachment(@Body() payload: MicroservicePayload): Promise<MicroserviceResponse> {
    ...
    const auditContext = this.createAuditContext(payload);
    return runWithAuditContext(auditContext, () =>
      this.vendorBusinessTypeCommentService.removeAttachment(id, fileToken),
    );
  }
}
