...
import {
  CreatePricelistTemplateDetailCommentSchema,
  UpdatePricelistTemplateDetailCommentSchema,
  AttachmentSchema,
} from './dto/pricelist-template-detail-comment.dto';
...
export class PricelistTemplateDetailCommentController {
  private readonly logger: BackendLogger = new BackendLogger(
    PricelistTemplateDetailCommentController.name,
  );

  constructor(
    private readonly pricelistTemplateDetailCommentService: PricelistTemplateDetailCommentService,
  ) {}
   ...
   */
  @MessagePattern({
    cmd: 'pricelist-template-detail-comment.find-by-id',
    service: 'pricelist-template-detail-comment',
  })
  async findById(@Body() payload: MicroservicePayload): Promise<MicroserviceResponse> {
    ...
    await this.pricelistTemplateDetailCommentService.initializePrismaService(
      bu_code,
      user_id,
    );
    const auditContext = this.createAuditContext(payload);
    return runWithAuditContext(auditContext, () =>
      this.pricelistTemplateDetailCommentService.findById(id),
    );
  }
   ...
   */
  @MessagePattern({
    cmd: 'pricelist-template-detail-comment.find-all-by-pricelist-template-detail-id',
    service: 'pricelist-template-detail-comment',
  })
  async findAllByPricelistTemplateDetailId(@Body() payload: MicroservicePayload): Promise<MicroserviceResponse> {
    this.logger.debug(
      { function: 'findAllByPricelistTemplateDetailId', payload },
      PricelistTemplateDetailCommentController.name,
    );

    const { pricelist_template_detail_id, user_id, bu_code, paginate } = payload;
    ...
    const auditContext = this.createAuditContext(payload);
    return runWithAuditContext(auditContext, () =>
      this.pricelistTemplateDetailCommentService.findAllByPricelistTemplateDetailId(
        pricelist_template_detail_id,
        paginate,
      ),
    );
  }
   ...
   */
  @MessagePattern({
    cmd: 'pricelist-template-detail-comment.create',
    service: 'pricelist-template-detail-comment',
  })
  async create(@Body() payload: MicroservicePayload): Promise<MicroserviceResponse> {
    ...
    const parsedData = CreatePricelistTemplateDetailCommentSchema.parse(data);

    const auditContext = this.createAuditContext(payload);
    return runWithAuditContext(auditContext, () =>
      this.pricelistTemplateDetailCommentService.create(parsedData),
    );
  }
   ...
   */
  @MessagePattern({
    cmd: 'pricelist-template-detail-comment.update',
    service: 'pricelist-template-detail-comment',
  })
  async update(@Body() payload: MicroservicePayload): Promise<MicroserviceResponse> {
    ...
    const parsedData = UpdatePricelistTemplateDetailCommentSchema.parse(data);

    const auditContext = this.createAuditContext(payload);
    return runWithAuditContext(auditContext, () =>
      this.pricelistTemplateDetailCommentService.update(id, parsedData),
    );
  }
   ...
   */
  @MessagePattern({
    cmd: 'pricelist-template-detail-comment.delete',
    service: 'pricelist-template-detail-comment',
  })
  async delete(@Body() payload: MicroservicePayload): Promise<MicroserviceResponse> {
    ...
    const auditContext = this.createAuditContext(payload);
    return runWithAuditContext(auditContext, () =>
      this.pricelistTemplateDetailCommentService.delete(id),
    );
  }
   ...
   */
  @MessagePattern({
    cmd: 'pricelist-template-detail-comment.add-attachment',
    service: 'pricelist-template-detail-comment',
  })
  async addAttachment(@Body() payload: MicroservicePayload): Promise<MicroserviceResponse> {
    ...
    const auditContext = this.createAuditContext(payload);
    return runWithAuditContext(auditContext, () =>
      this.pricelistTemplateDetailCommentService.addAttachment(id, parsedAttachment),
    );
  }
   ...
   */
  @MessagePattern({
    cmd: 'pricelist-template-detail-comment.remove-attachment',
    service: 'pricelist-template-detail-comment',
  })
  async removeAttachment(@Body() payload: MicroservicePayload): Promise<MicroserviceResponse> {
    ...
    const auditContext = this.createAuditContext(payload);
    return runWithAuditContext(auditContext, () =>
      this.pricelistTemplateDetailCommentService.removeAttachment(id, fileToken),
    );
  }
}
