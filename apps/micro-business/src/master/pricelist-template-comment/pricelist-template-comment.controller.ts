...
import {
  CreatePricelistTemplateCommentSchema,
  UpdatePricelistTemplateCommentSchema,
  AttachmentSchema,
...
export class PricelistTemplateCommentController {
   ...
   */
  @MessagePattern({
    cmd: 'pricelist-template-comment.find-by-id',
    service: 'pricelist-template-comment',
  })
  async findById(@Body() payload: MicroservicePayload): Promise<MicroserviceResponse> {
    ...
    await this.pricelistTemplateCommentService.initializePrismaService(
      bu_code,
      user_id,
    );
    const auditContext = this.createAuditContext(payload);
    return runWithAuditContext(auditContext, () =>
      this.pricelistTemplateCommentService.findById(id),
    );
  }
   ...
   */
  @MessagePattern({
    cmd: 'pricelist-template-comment.find-all-by-pricelist-template-id',
    service: 'pricelist-template-comment',
  })
  async findAllByPricelistTemplateId(@Body() payload: MicroservicePayload): Promise<MicroserviceResponse> {
    this.logger.debug(
      { function: 'findAllByPricelistTemplateId', payload },
      PricelistTemplateCommentController.name,
    );

    const { pricelist_template_id, user_id, bu_code, paginate } = payload;
    ...
    const auditContext = this.createAuditContext(payload);
    return runWithAuditContext(auditContext, () =>
      this.pricelistTemplateCommentService.findAllByPricelistTemplateId(
   ...
   */
  @MessagePattern({
    cmd: 'pricelist-template-comment.create',
    service: 'pricelist-template-comment',
  })
  async create(@Body() payload: MicroservicePayload): Promise<MicroserviceResponse> {
    ...
    const parsedData = CreatePricelistTemplateCommentSchema.parse(data);

    const auditContext = this.createAuditContext(payload);
    return runWithAuditContext(auditContext, () =>
      this.pricelistTemplateCommentService.create(parsedData),
    );
  }
   ...
   */
  @MessagePattern({
    cmd: 'pricelist-template-comment.update',
    service: 'pricelist-template-comment',
  })
  async update(@Body() payload: MicroservicePayload): Promise<MicroserviceResponse> {
    ...
    const parsedData = UpdatePricelistTemplateCommentSchema.parse(data);

    const auditContext = this.createAuditContext(payload);
    return runWithAuditContext(auditContext, () =>
      this.pricelistTemplateCommentService.update(id, parsedData),
    );
  }
   ...
   */
  @MessagePattern({
    cmd: 'pricelist-template-comment.delete',
    service: 'pricelist-template-comment',
  })
  async delete(@Body() payload: MicroservicePayload): Promise<MicroserviceResponse> {
    ...
    const auditContext = this.createAuditContext(payload);
    return runWithAuditContext(auditContext, () =>
      this.pricelistTemplateCommentService.delete(id),
    );
  }
   ...
   */
  @MessagePattern({
    cmd: 'pricelist-template-comment.add-attachment',
    service: 'pricelist-template-comment',
  })
  async addAttachment(@Body() payload: MicroservicePayload): Promise<MicroserviceResponse> {
    ...
    const auditContext = this.createAuditContext(payload);
    return runWithAuditContext(auditContext, () =>
      this.pricelistTemplateCommentService.addAttachment(id, parsedAttachment),
    );
  }
   ...
   */
  @MessagePattern({
    cmd: 'pricelist-template-comment.remove-attachment',
    service: 'pricelist-template-comment',
  })
  async removeAttachment(@Body() payload: MicroservicePayload): Promise<MicroserviceResponse> {
    ...
    const auditContext = this.createAuditContext(payload);
    return runWithAuditContext(auditContext, () =>
      this.pricelistTemplateCommentService.removeAttachment(id, fileToken),
    );
  }
}
