...
import {
  CreateDimensionCommentSchema,
  UpdateDimensionCommentSchema,
  AttachmentSchema,
...
export class DimensionCommentController {
   ...
   */
  @MessagePattern({
    cmd: 'dimension-comment.find-by-id',
    service: 'dimension-comment',
  })
  async findById(@Body() payload: MicroservicePayload): Promise<MicroserviceResponse> {
    ...
    await this.dimensionCommentService.initializePrismaService(
      bu_code,
      user_id,
    );
    const auditContext = this.createAuditContext(payload);
    return runWithAuditContext(auditContext, () =>
      this.dimensionCommentService.findById(id),
    );
  }
   ...
   */
  @MessagePattern({
    cmd: 'dimension-comment.find-all-by-dimension-id',
    service: 'dimension-comment',
  })
  async findAllByDimensionId(@Body() payload: MicroservicePayload): Promise<MicroserviceResponse> {
    this.logger.debug(
      { function: 'findAllByDimensionId', payload },
      DimensionCommentController.name,
    );

    const { dimension_id, user_id, bu_code, paginate } = payload;
    ...
    const auditContext = this.createAuditContext(payload);
    return runWithAuditContext(auditContext, () =>
      this.dimensionCommentService.findAllByDimensionId(
        dimension_id,
        paginate,
      ),
    );
  ...
  async create(@Body() payload: MicroservicePayload): Promise<MicroserviceResponse> {
    ...
    const parsedData = CreateDimensionCommentSchema.parse(data);

    const auditContext = this.createAuditContext(payload);
    return runWithAuditContext(auditContext, () =>
      this.dimensionCommentService.create(parsedData),
    );
  }
  ...
  async update(@Body() payload: MicroservicePayload): Promise<MicroserviceResponse> {
    ...
    const parsedData = UpdateDimensionCommentSchema.parse(data);

    const auditContext = this.createAuditContext(payload);
    return runWithAuditContext(auditContext, () =>
      this.dimensionCommentService.update(id, parsedData),
    );
  }
  ...
  async delete(@Body() payload: MicroservicePayload): Promise<MicroserviceResponse> {
    ...
    const auditContext = this.createAuditContext(payload);
    return runWithAuditContext(auditContext, () =>
      this.dimensionCommentService.delete(id),
    );
  }
   ...
   */
  @MessagePattern({
    cmd: 'dimension-comment.add-attachment',
    service: 'dimension-comment',
  })
  async addAttachment(@Body() payload: MicroservicePayload): Promise<MicroserviceResponse> {
    ...
    const auditContext = this.createAuditContext(payload);
    return runWithAuditContext(auditContext, () =>
      this.dimensionCommentService.addAttachment(id, parsedAttachment),
    );
  }
   ...
   */
  @MessagePattern({
    cmd: 'dimension-comment.remove-attachment',
    service: 'dimension-comment',
  })
  async removeAttachment(@Body() payload: MicroservicePayload): Promise<MicroserviceResponse> {
    ...
    const auditContext = this.createAuditContext(payload);
    return runWithAuditContext(auditContext, () =>
      this.dimensionCommentService.removeAttachment(id, fileToken),
    );
  }
}
