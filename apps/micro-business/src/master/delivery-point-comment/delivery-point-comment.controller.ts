...
import {
  CreateDeliveryPointCommentSchema,
  UpdateDeliveryPointCommentSchema,
  AttachmentSchema,
...
export class DeliveryPointCommentController {
   ...
   */
  @MessagePattern({
    cmd: 'delivery-point-comment.find-by-id',
    service: 'delivery-point-comment',
  })
  async findById(@Body() payload: MicroservicePayload): Promise<MicroserviceResponse> {
    ...
    await this.deliveryPointCommentService.initializePrismaService(
      bu_code,
      user_id,
    );
    const auditContext = this.createAuditContext(payload);
    return runWithAuditContext(auditContext, () =>
      this.deliveryPointCommentService.findById(id),
    );
  }
   ...
   */
  @MessagePattern({
    cmd: 'delivery-point-comment.find-all-by-delivery-point-id',
    service: 'delivery-point-comment',
  })
  async findAllByDeliveryPointId(@Body() payload: MicroservicePayload): Promise<MicroserviceResponse> {
    this.logger.debug(
      { function: 'findAllByDeliveryPointId', payload },
      DeliveryPointCommentController.name,
    );

    const { delivery_point_id, user_id, bu_code, paginate } = payload;
    ...
    const auditContext = this.createAuditContext(payload);
    return runWithAuditContext(auditContext, () =>
      this.deliveryPointCommentService.findAllByDeliveryPointId(
        delivery_point_id,
        paginate,
      ),
    );
   ...
   */
  @MessagePattern({
    cmd: 'delivery-point-comment.create',
    service: 'delivery-point-comment',
  })
  async create(@Body() payload: MicroservicePayload): Promise<MicroserviceResponse> {
    ...
    const parsedData = CreateDeliveryPointCommentSchema.parse(data);

    const auditContext = this.createAuditContext(payload);
    return runWithAuditContext(auditContext, () =>
      this.deliveryPointCommentService.create(parsedData),
    );
  }
   ...
   */
  @MessagePattern({
    cmd: 'delivery-point-comment.update',
    service: 'delivery-point-comment',
  })
  async update(@Body() payload: MicroservicePayload): Promise<MicroserviceResponse> {
    ...
    const parsedData = UpdateDeliveryPointCommentSchema.parse(data);

    const auditContext = this.createAuditContext(payload);
    return runWithAuditContext(auditContext, () =>
      this.deliveryPointCommentService.update(id, parsedData),
    );
  }
   ...
   */
  @MessagePattern({
    cmd: 'delivery-point-comment.delete',
    service: 'delivery-point-comment',
  })
  async delete(@Body() payload: MicroservicePayload): Promise<MicroserviceResponse> {
    ...
    const auditContext = this.createAuditContext(payload);
    return runWithAuditContext(auditContext, () =>
      this.deliveryPointCommentService.delete(id),
    );
  }
   ...
   */
  @MessagePattern({
    cmd: 'delivery-point-comment.add-attachment',
    service: 'delivery-point-comment',
  })
  async addAttachment(@Body() payload: MicroservicePayload): Promise<MicroserviceResponse> {
    ...
    const auditContext = this.createAuditContext(payload);
    return runWithAuditContext(auditContext, () =>
      this.deliveryPointCommentService.addAttachment(id, parsedAttachment),
    );
  }
   ...
   */
  @MessagePattern({
    cmd: 'delivery-point-comment.remove-attachment',
    service: 'delivery-point-comment',
  })
  async removeAttachment(@Body() payload: MicroservicePayload): Promise<MicroserviceResponse> {
    ...
    const auditContext = this.createAuditContext(payload);
    return runWithAuditContext(auditContext, () =>
      this.deliveryPointCommentService.removeAttachment(id, fileToken),
    );
  }
}
