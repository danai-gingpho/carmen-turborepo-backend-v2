 ...
 */
export const UpdateProductCategoryCommentBodySchema = z.object({
...
export type UpdateProductCategoryCommentBody = z.infer<typeof UpdateProductCategoryCommentBodySchema>;

export class UpdateProductCategoryCommentDto {
  @ApiPropertyOptional({
...
export class UpdateProductCategoryCommentBodyDto extends createZodDto(
