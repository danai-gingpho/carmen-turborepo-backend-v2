...
export class ProductCategoryCommentResponseDto {
  @ApiProperty({ description: 'Comment ID', example: 'a1b2c3d4-e5f6-7890-abcd-ef1234567890' }) id: string;
  @ApiProperty({ description: 'ProductCategory ID', example: '123e4567-e89b-12d3-a456-426614174000' }) product_category_id: string;
...
export class ProductCategoryCommentListResponseDto {
  @ApiProperty({ description: 'List of product-category comment records', type: [ProductCategoryCommentResponseDto] }) data: ProductCategoryCommentResponseDto[];
...
export class ProductCategoryCommentMutationResponseDto {
  @ApiProperty({ description: 'ProductCategory comment ID', example: 'a1b2c3d4-e5f6-7890-abcd-ef1234567890' }) id: string;
}
