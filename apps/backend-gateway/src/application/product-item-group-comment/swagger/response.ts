...
export class ProductItemGroupCommentResponseDto {
  @ApiProperty({ description: 'Comment ID', example: 'a1b2c3d4-e5f6-7890-abcd-ef1234567890' }) id: string;
  @ApiProperty({ description: 'ProductItemGroup ID', example: '123e4567-e89b-12d3-a456-426614174000' }) product_item_group_id: string;
...
export class ProductItemGroupCommentListResponseDto {
  @ApiProperty({ description: 'List of product-item-group comment records', type: [ProductItemGroupCommentResponseDto] }) data: ProductItemGroupCommentResponseDto[];
...
export class ProductItemGroupCommentMutationResponseDto {
  @ApiProperty({ description: 'ProductItemGroup comment ID', example: 'a1b2c3d4-e5f6-7890-abcd-ef1234567890' }) id: string;
}
