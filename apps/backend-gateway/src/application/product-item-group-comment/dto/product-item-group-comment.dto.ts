 ...
 */
export const UpdateProductItemGroupCommentBodySchema = z.object({
...
export type UpdateProductItemGroupCommentBody = z.infer<typeof UpdateProductItemGroupCommentBodySchema>;

export class UpdateProductItemGroupCommentDto {
  @ApiPropertyOptional({
...
export class UpdateProductItemGroupCommentBodyDto extends createZodDto(
