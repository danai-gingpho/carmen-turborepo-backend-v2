 ...
 */
export const UpdateWorkflowCommentBodySchema = z.object({
...
export type UpdateWorkflowCommentBody = z.infer<typeof UpdateWorkflowCommentBodySchema>;
...
export class UpdateWorkflowCommentBodyDto extends createZodDto(
