...
export class WorkflowCommentResponseDto {
  @ApiProperty({ description: 'Comment ID', example: 'a1b2c3d4-e5f6-7890-abcd-ef1234567890' }) id: string;
  @ApiProperty({ description: 'Workflow ID', example: '123e4567-e89b-12d3-a456-426614174000' }) workflow_id: string;
...
export class WorkflowCommentListResponseDto {
  @ApiProperty({ description: 'List of workflow comment records', type: [WorkflowCommentResponseDto] }) data: WorkflowCommentResponseDto[];
...
export class WorkflowCommentMutationResponseDto {
  @ApiProperty({ description: 'Workflow comment ID', example: 'a1b2c3d4-e5f6-7890-abcd-ef1234567890' }) id: string;
}
