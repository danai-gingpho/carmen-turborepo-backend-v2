 ...
 */
export const UpdateProductSubCategoryCommentBodySchema = z.object({
...
export type UpdateProductSubCategoryCommentBody = z.infer<typeof UpdateProductSubCategoryCommentBodySchema>;

export class UpdateProductSubCategoryCommentDto {
  @ApiPropertyOptional({
...
export class UpdateProductSubCategoryCommentBodyDto extends createZodDto(
