...
export class ProductSubCategoryCommentResponseDto {
  @ApiProperty({ description: 'Comment ID', example: 'a1b2c3d4-e5f6-7890-abcd-ef1234567890' }) id: string;
  @ApiProperty({ description: 'ProductSubCategory ID', example: '123e4567-e89b-12d3-a456-426614174000' }) product_sub_category_id: string;
...
export class ProductSubCategoryCommentListResponseDto {
  @ApiProperty({ description: 'List of product-sub-category comment records', type: [ProductSubCategoryCommentResponseDto] }) data: ProductSubCategoryCommentResponseDto[];
...
export class ProductSubCategoryCommentMutationResponseDto {
  @ApiProperty({ description: 'ProductSubCategory comment ID', example: 'a1b2c3d4-e5f6-7890-abcd-ef1234567890' }) id: string;
}
