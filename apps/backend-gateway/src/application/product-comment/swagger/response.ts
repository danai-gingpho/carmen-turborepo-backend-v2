...
export class ProductCommentResponseDto {
  ...
  @ApiProperty({ description: 'Product ID', example: '123e4567-e89b-12d3-a456-426614174000' }) product_id: string;
...
export class ProductCommentListResponseDto {
  @ApiProperty({ description: 'List of product comment records', type: [ProductCommentResponseDto] }) data: ProductCommentResponseDto[];
...
export class ProductCommentMutationResponseDto {
  @ApiProperty({ description: 'Product comment ID', example: 'a1b2c3d4-e5f6-7890-abcd-ef1234567890' }) id: string;
}
