...
// Note: *_name fields are populated by mapper from their corresponding *_id fields
const CreatePurchaseRequestTemplateDetailSchema = z.object({
...
export type CreatePurchaseRequestTemplate = z.infer<
  typeof CreatePurchaseRequestTemplateSchema
>;

export class CreatePurchaseRequestTemplateDto extends createZodDto(
  CreatePurchaseRequestTemplateSchema,
) { }
