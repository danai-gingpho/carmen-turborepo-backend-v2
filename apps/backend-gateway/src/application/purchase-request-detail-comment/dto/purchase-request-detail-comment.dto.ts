 ...
 */
export const UpdatePurchaseRequestDetailCommentBodySchema = z.object({
...
export type UpdatePurchaseRequestDetailCommentBody = z.infer<typeof UpdatePurchaseRequestDetailCommentBodySchema>;

export class UpdatePurchaseRequestDetailCommentDto {
  @ApiPropertyOptional({
...
export class UpdatePurchaseRequestDetailCommentBodyDto extends createZodDto(
