...
import {
  ...
  UpdatePurchaseRequestDetailCommentBodySchema,
  AddAttachmentsDto,
...
export class PurchaseRequestDetailCommentController {
  ...
  @Get(':bu_code/purchase-request-detail-comment/:purchase_request_detail_id')
  ...
  async findAllByParentId(
    ...
    return this.purchaseRequestDetailCommentService.findAllByParentId(
  ...
  @ApiVersionMinRequest()
  @ApiOperation({
    summary: 'Update a purchase-request-detail comment with attachment add/remove',
  ...
  async update(
    ...
    const parsed = UpdatePurchaseRequestDetailCommentBodySchema.safeParse(rawBody);
    if (!parsed.success) {
    ...
    const { user_id } = ExtractRequestHeader(req);
    return this.purchaseRequestDetailCommentService.update(
      id,
      {
  ...
  @ApiVersionMinRequest()
  @ApiOperation({
    summary: 'Add attachments to a purchase-request-detail comment',
    operationId: 'addAttachmentsToPurchaseRequestDetailComment',
    responses: {
  ...
  async addAttachment(
    ...
    const { user_id } = ExtractRequestHeader(req);
    return this.purchaseRequestDetailCommentService.addAttachments(
      id,
      files,
      user_id,
      bu_code,
  ...
  @Post(':bu_code/purchase-request-detail-comment/:purchase_request_detail_id')
  ...
  async createWithFiles(
    @Param('bu_code') bu_code: string,
    @Param('purchase_request_detail_id', new ParseUUIDPipe({ version: '4' }))
    ...
    return this.purchaseRequestDetailCommentService.createWithFiles(
      files,
      { ...body, purchase_request_detail_id },
      user_id,
      bu_code,
      version,
    );
