 ...
 */
export const UpdateVendorCommentBodySchema = z.object({
...
export type UpdateVendorCommentBody = z.infer<typeof UpdateVendorCommentBodySchema>;

export class UpdateVendorCommentDto {
  @ApiPropertyOptional({
...
export class UpdateVendorCommentBodyDto extends createZodDto(
