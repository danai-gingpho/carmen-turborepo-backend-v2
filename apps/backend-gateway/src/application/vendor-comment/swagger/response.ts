...
export class VendorCommentResponseDto {
  @ApiProperty({ description: 'Comment ID', example: 'a1b2c3d4-e5f6-7890-abcd-ef1234567890' }) id: string;
  @ApiProperty({ description: 'Vendor ID', example: '123e4567-e89b-12d3-a456-426614174000' }) vendor_id: string;
...
export class VendorCommentListResponseDto {
  @ApiProperty({ description: 'List of vendor comment records', type: [VendorCommentResponseDto] }) data: VendorCommentResponseDto[];
...
export class VendorCommentMutationResponseDto {
  @ApiProperty({ description: 'Vendor comment ID', example: 'a1b2c3d4-e5f6-7890-abcd-ef1234567890' }) id: string;
}
