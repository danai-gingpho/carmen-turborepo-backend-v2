 ...
 */
export const UpdateLocationCommentBodySchema = z.object({
...
export type UpdateLocationCommentBody = z.infer<typeof UpdateLocationCommentBodySchema>;

export class UpdateLocationCommentDto {
  @ApiPropertyOptional({
...
export class UpdateLocationCommentBodyDto extends createZodDto(
