...
export class LocationCommentResponseDto {
  @ApiProperty({ description: 'Comment ID', example: 'a1b2c3d4-e5f6-7890-abcd-ef1234567890' }) id: string;
  @ApiProperty({ description: 'Location ID', example: '123e4567-e89b-12d3-a456-426614174000' }) location_id: string;
...
export class LocationCommentListResponseDto {
  @ApiProperty({ description: 'List of location comment records', type: [LocationCommentResponseDto] }) data: LocationCommentResponseDto[];
...
export class LocationCommentMutationResponseDto {
  @ApiProperty({ description: 'Location comment ID', example: 'a1b2c3d4-e5f6-7890-abcd-ef1234567890' }) id: string;
}
