 ...
 */
export const UpdateStoreRequisitionDetailCommentBodySchema = z.object({
...
export type UpdateStoreRequisitionDetailCommentBody = z.infer<typeof UpdateStoreRequisitionDetailCommentBodySchema>;

export class UpdateStoreRequisitionDetailCommentDto {
  @ApiPropertyOptional({
...
export class UpdateStoreRequisitionDetailCommentBodyDto extends createZodDto(
  UpdateStoreRequisitionDetailCommentBodySchema,
) {}
