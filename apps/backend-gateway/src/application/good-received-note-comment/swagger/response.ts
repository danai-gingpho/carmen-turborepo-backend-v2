...
export class GoodReceivedNoteCommentResponseDto {
  @ApiProperty({ description: 'Comment ID', example: 'a1b2c3d4-e5f6-7890-abcd-ef1234567890' })
  id: string;
  @ApiProperty({ description: 'GoodReceivedNote ID', example: '123e4567-e89b-12d3-a456-426614174000' })
...
export class GoodReceivedNoteCommentListResponseDto {
  @ApiProperty({ description: 'List of good-received-note comment records', type: [GoodReceivedNoteCommentResponseDto] })
  data: GoodReceivedNoteCommentResponseDto[];
...
export class GoodReceivedNoteCommentMutationResponseDto {
  @ApiProperty({ description: 'GoodReceivedNote comment ID', example: 'a1b2c3d4-e5f6-7890-abcd-ef1234567890' })
  id: string;
}
