 ...
 */
export const UpdatePricelistCommentBodySchema = z.object({
...
export type UpdatePricelistCommentBody = z.infer<typeof UpdatePricelistCommentBodySchema>;

export class UpdatePricelistCommentDto {
  @ApiPropertyOptional({
...
export class UpdatePricelistCommentBodyDto extends createZodDto(
