...
export class PricelistCommentResponseDto {
  @ApiProperty({ description: 'Comment ID', example: 'a1b2c3d4-e5f6-7890-abcd-ef1234567890' }) id: string;
  @ApiProperty({ description: 'Pricelist ID', example: '123e4567-e89b-12d3-a456-426614174000' }) pricelist_id: string;
...
export class PricelistCommentListResponseDto {
  @ApiProperty({ description: 'List of pricelist comment records', type: [PricelistCommentResponseDto] }) data: PricelistCommentResponseDto[];
...
export class PricelistCommentMutationResponseDto {
  @ApiProperty({ description: 'Pricelist comment ID', example: 'a1b2c3d4-e5f6-7890-abcd-ef1234567890' }) id: string;
}
