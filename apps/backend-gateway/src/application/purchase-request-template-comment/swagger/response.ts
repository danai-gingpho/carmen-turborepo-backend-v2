...
export class PurchaseRequestTemplateCommentResponseDto {
  @ApiProperty({ description: 'Comment ID', example: 'a1b2c3d4-e5f6-7890-abcd-ef1234567890' })
  id: string;
  @ApiProperty({ description: 'PurchaseRequestTemplate ID', example: '123e4567-e89b-12d3-a456-426614174000' })
...
export class PurchaseRequestTemplateCommentListResponseDto {
  @ApiProperty({ description: 'List of purchase-request-template comment records', type: [PurchaseRequestTemplateCommentResponseDto] })
  data: PurchaseRequestTemplateCommentResponseDto[];
...
export class PurchaseRequestTemplateCommentMutationResponseDto {
  @ApiProperty({ description: 'PurchaseRequestTemplate comment ID', example: 'a1b2c3d4-e5f6-7890-abcd-ef1234567890' })
  id: string;
}
