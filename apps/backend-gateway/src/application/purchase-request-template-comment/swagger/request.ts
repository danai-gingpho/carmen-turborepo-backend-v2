...
export class CreatePurchaseRequestTemplateCommentRequestDto {
  ...
  message?: string | null;
  @ApiPropertyOptional({ description: 'Comment type', enum: ['user', 'system'], default: 'user', example: 'user' })
  type?: string;
  @ApiPropertyOptional({ description: 'File attachments', type: [AttachmentDto] })
  attachments?: AttachmentDto[];
}

export class UpdatePurchaseRequestTemplateCommentRequestDto {
  @ApiPropertyOptional({ description: 'Updated comment message', example: 'Updated comment' })
  message?: string | null;
  @ApiPropertyOptional({ description: 'Updated file attachments', type: [AttachmentDto] })
  attachments?: AttachmentDto[];
}
