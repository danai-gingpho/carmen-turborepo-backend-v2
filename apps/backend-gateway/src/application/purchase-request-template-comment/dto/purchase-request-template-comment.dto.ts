 ...
 */
export const UpdatePurchaseRequestTemplateCommentBodySchema = z.object({
...
export type UpdatePurchaseRequestTemplateCommentBody = z.infer<typeof UpdatePurchaseRequestTemplateCommentBodySchema>;

export class UpdatePurchaseRequestTemplateCommentDto {
  @ApiPropertyOptional({
...
export class UpdatePurchaseRequestTemplateCommentBodyDto extends createZodDto(
