 ...
 */
export const UpdateExtraCostCommentBodySchema = z.object({
...
export type UpdateExtraCostCommentBody = z.infer<typeof UpdateExtraCostCommentBodySchema>;

export class UpdateExtraCostCommentDto {
  @ApiPropertyOptional({
...
export class UpdateExtraCostCommentBodyDto extends createZodDto(
