...
export class ExtraCostCommentResponseDto {
  @ApiProperty({ description: 'Comment ID', example: 'a1b2c3d4-e5f6-7890-abcd-ef1234567890' })
  id: string;
  @ApiProperty({ description: 'ExtraCost ID', example: '123e4567-e89b-12d3-a456-426614174000' })
...
export class ExtraCostCommentListResponseDto {
  @ApiProperty({ description: 'List of extra-cost comment records', type: [ExtraCostCommentResponseDto] })
  data: ExtraCostCommentResponseDto[];
...
export class ExtraCostCommentMutationResponseDto {
  @ApiProperty({ description: 'ExtraCost comment ID', example: 'a1b2c3d4-e5f6-7890-abcd-ef1234567890' })
  id: string;
}
