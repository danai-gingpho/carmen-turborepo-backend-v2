 ...
 */
export const UpdateRequestForPricingDetailCommentBodySchema = z.object({
...
export type UpdateRequestForPricingDetailCommentBody = z.infer<typeof UpdateRequestForPricingDetailCommentBodySchema>;

export class UpdateRequestForPricingDetailCommentDto {
  @ApiPropertyOptional({
...
export class UpdateRequestForPricingDetailCommentBodyDto extends createZodDto(
