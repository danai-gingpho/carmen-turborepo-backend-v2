...
export class RequestForPricingDetailCommentResponseDto {
  @ApiProperty({ description: 'Comment ID', example: 'a1b2c3d4-e5f6-7890-abcd-ef1234567890' })
  id: string;
  @ApiProperty({ description: 'RequestForPricingDetail ID', example: '123e4567-e89b-12d3-a456-426614174000' })
...
export class RequestForPricingDetailCommentListResponseDto {
  @ApiProperty({ description: 'List of request-for-pricing-detail comment records', type: [RequestForPricingDetailCommentResponseDto] })
  data: RequestForPricingDetailCommentResponseDto[];
...
export class RequestForPricingDetailCommentMutationResponseDto {
  @ApiProperty({ description: 'RequestForPricingDetail comment ID', example: 'a1b2c3d4-e5f6-7890-abcd-ef1234567890' })
  id: string;
}
