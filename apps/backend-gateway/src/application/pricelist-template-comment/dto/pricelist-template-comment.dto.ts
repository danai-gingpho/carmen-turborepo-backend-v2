 ...
 */
export const UpdatePricelistTemplateCommentBodySchema = z.object({
...
export type UpdatePricelistTemplateCommentBody = z.infer<typeof UpdatePricelistTemplateCommentBodySchema>;

export class UpdatePricelistTemplateCommentDto {
  @ApiPropertyOptional({
...
export class UpdatePricelistTemplateCommentBodyDto extends createZodDto(
