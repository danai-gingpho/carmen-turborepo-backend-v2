 ...
 */
export const UpdateStockInCommentBodySchema = z.object({
...
export type UpdateStockInCommentBody = z.infer<typeof UpdateStockInCommentBodySchema>;

export class UpdateStockInCommentDto {
  @ApiPropertyOptional({
...
export class UpdateStockInCommentBodyDto extends createZodDto(
