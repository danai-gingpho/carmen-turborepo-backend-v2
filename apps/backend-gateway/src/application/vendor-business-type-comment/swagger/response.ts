...
export class VendorBusinessTypeCommentResponseDto {
  @ApiProperty({ description: 'Comment ID', example: 'a1b2c3d4-e5f6-7890-abcd-ef1234567890' }) id: string;
  @ApiProperty({ description: 'VendorBusinessType ID', example: '123e4567-e89b-12d3-a456-426614174000' }) vendor_business_type_id: string;
...
export class VendorBusinessTypeCommentListResponseDto {
  @ApiProperty({ description: 'List of vendor-business-type comment records', type: [VendorBusinessTypeCommentResponseDto] }) data: VendorBusinessTypeCommentResponseDto[];
...
export class VendorBusinessTypeCommentMutationResponseDto {
  @ApiProperty({ description: 'VendorBusinessType comment ID', example: 'a1b2c3d4-e5f6-7890-abcd-ef1234567890' }) id: string;
}
