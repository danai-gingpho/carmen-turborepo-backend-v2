...
import {
  UpdateVendorBusinessTypeCommentDto,
  UpdateVendorBusinessTypeCommentBodySchema,
  AddAttachmentsDto,
...
export class VendorBusinessTypeCommentController {
  ...
  @Get(':bu_code/vendor-business-type-comment/:vendor_business_type_id')
  @UseGuards(new AppIdGuard('vendorBusinessTypeComment.findAll'))
  @ApiVersionMinRequest()
  @ApiUserFilterQueries()
  @ApiOperation({
    summary: 'Get all comments for a vendor-business-type',
    operationId: 'findAllVendorBusinessTypeComments',
    responses: {
  ...
  async findAllByParentId(
    ...
    @Param('vendor_business_type_id', new ParseUUIDPipe({ version: '4' })) vendor_business_type_id: string,
    @Req() req: Request,
    ...
    return this.vendorBusinessTypeCommentService.findAllByParentId(
  ...
  @ApiVersionMinRequest()
  @ApiOperation({
    summary: 'Update a vendor-business-type comment with attachment add/remove',
    operationId: 'updateVendorBusinessTypeComment',
    responses: {
  ...
  async update(
    ...
    const parsed = UpdateVendorBusinessTypeCommentBodySchema.safeParse(rawBody);
    if (!parsed.success) {
    ...
    const { user_id } = ExtractRequestHeader(req);
    return this.vendorBusinessTypeCommentService.update(
      id,
      {
  ...
  @ApiVersionMinRequest()
  @ApiOperation({
    summary: 'Delete a vendor-business-type comment',
    operationId: 'deleteVendorBusinessTypeComment',
    responses: {
  ...
  @ApiVersionMinRequest()
  @ApiOperation({
    summary: 'Add attachments to a vendor-business-type comment',
    operationId: 'addAttachmentsToVendorBusinessTypeComment',
    responses: {
  ...
  async addAttachment(
    ...
    const { user_id } = ExtractRequestHeader(req);
    return this.vendorBusinessTypeCommentService.addAttachments(
      id,
      files,
      user_id,
      bu_code,
  ...
  @ApiVersionMinRequest()
  @ApiOperation({
    summary: 'Remove an attachment from a vendor-business-type comment',
    operationId: 'removeAttachmentFromVendorBusinessTypeComment',
    responses: {
  ...
  @Post(':bu_code/vendor-business-type-comment/:vendor_business_type_id')
  ...
  async createWithFiles(
    @Param('bu_code') bu_code: string,
    @Param('vendor_business_type_id', new ParseUUIDPipe({ version: '4' }))
