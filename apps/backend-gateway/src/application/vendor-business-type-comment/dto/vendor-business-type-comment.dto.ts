 ...
 */
export const UpdateVendorBusinessTypeCommentBodySchema = z.object({
...
export type UpdateVendorBusinessTypeCommentBody = z.infer<typeof UpdateVendorBusinessTypeCommentBodySchema>;

export class UpdateVendorBusinessTypeCommentDto {
  @ApiPropertyOptional({
...
export class UpdateVendorBusinessTypeCommentBodyDto extends createZodDto(
