 ...
 */
export const UpdatePricelistTemplateDetailCommentBodySchema = z.object({
...
export type UpdatePricelistTemplateDetailCommentBody = z.infer<typeof UpdatePricelistTemplateDetailCommentBodySchema>;

export class UpdatePricelistTemplateDetailCommentDto {
  @ApiPropertyOptional({
...
export class UpdatePricelistTemplateDetailCommentBodyDto extends createZodDto(
