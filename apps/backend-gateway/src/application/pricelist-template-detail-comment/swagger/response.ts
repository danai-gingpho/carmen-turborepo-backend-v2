...
export class PricelistTemplateDetailCommentResponseDto {
  @ApiProperty({ description: 'Comment ID', example: 'a1b2c3d4-e5f6-7890-abcd-ef1234567890' }) id: string;
  @ApiProperty({ description: 'PricelistTemplateDetail ID', example: '123e4567-e89b-12d3-a456-426614174000' }) pricelist_template_detail_id: string;
...
export class PricelistTemplateDetailCommentListResponseDto {
  @ApiProperty({ description: 'List of pricelist-template-detail comment records', type: [PricelistTemplateDetailCommentResponseDto] }) data: PricelistTemplateDetailCommentResponseDto[];
...
export class PricelistTemplateDetailCommentMutationResponseDto {
  @ApiProperty({ description: 'PricelistTemplateDetail comment ID', example: 'a1b2c3d4-e5f6-7890-abcd-ef1234567890' }) id: string;
}
