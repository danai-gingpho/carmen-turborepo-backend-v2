 ...
 */
export const UpdateUnitCommentBodySchema = z.object({
...
export type UpdateUnitCommentBody = z.infer<typeof UpdateUnitCommentBodySchema>;
...
export class UpdateUnitCommentBodyDto extends createZodDto(
