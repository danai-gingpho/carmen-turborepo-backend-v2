...
export class UnitCommentResponseDto {
  ...
  @ApiProperty({ description: 'Unit ID', example: '123e4567-e89b-12d3-a456-426614174000' }) unit_id: string;
...
export class UnitCommentListResponseDto {
  @ApiProperty({ description: 'List of unit comment records', type: [UnitCommentResponseDto] }) data: UnitCommentResponseDto[];
...
export class UnitCommentMutationResponseDto {
  @ApiProperty({ description: 'Unit comment ID', example: 'a1b2c3d4-e5f6-7890-abcd-ef1234567890' }) id: string;
}
