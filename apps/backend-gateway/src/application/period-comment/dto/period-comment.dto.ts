 ...
 */
export const UpdatePeriodCommentBodySchema = z.object({
...
export type UpdatePeriodCommentBody = z.infer<typeof UpdatePeriodCommentBodySchema>;

export class UpdatePeriodCommentDto {
  @ApiPropertyOptional({
...
export class UpdatePeriodCommentBodyDto extends createZodDto(
