...
export class PeriodCommentResponseDto {
  @ApiProperty({ description: 'Comment ID', example: 'a1b2c3d4-e5f6-7890-abcd-ef1234567890' }) id: string;
  @ApiProperty({ description: 'Period ID', example: '123e4567-e89b-12d3-a456-426614174000' }) period_id: string;
...
export class PeriodCommentListResponseDto {
  @ApiProperty({ description: 'List of period comment records', type: [PeriodCommentResponseDto] }) data: PeriodCommentResponseDto[];
...
export class PeriodCommentMutationResponseDto {
  @ApiProperty({ description: 'Period comment ID', example: 'a1b2c3d4-e5f6-7890-abcd-ef1234567890' }) id: string;
}
