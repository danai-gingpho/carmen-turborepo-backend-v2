...
export class DimensionCommentResponseDto {
  @ApiProperty({ description: 'Comment ID', example: 'a1b2c3d4-e5f6-7890-abcd-ef1234567890' }) id: string;
  @ApiProperty({ description: 'Dimension ID', example: '123e4567-e89b-12d3-a456-426614174000' }) dimension_id: string;
...
export class DimensionCommentListResponseDto {
  @ApiProperty({ description: 'List of dimension comment records', type: [DimensionCommentResponseDto] }) data: DimensionCommentResponseDto[];
...
export class DimensionCommentMutationResponseDto {
  @ApiProperty({ description: 'Dimension comment ID', example: 'a1b2c3d4-e5f6-7890-abcd-ef1234567890' }) id: string;
}
