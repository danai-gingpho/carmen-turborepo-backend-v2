...
export class PurchaseRequestCommentListResponseDto {
  @ApiProperty({ description: 'List of purchase request comment records', type: [PurchaseRequestCommentResponseDto] })
  data: PurchaseRequestCommentResponseDto[];
...
export class PurchaseRequestCommentMutationResponseDto {
  @ApiProperty({ description: 'Purchase request comment ID', example: 'a1b2c3d4-e5f6-7890-abcd-ef1234567890' })
  id: string;
}
