 ...
 */
export const UpdateConfigRunningCodeCommentBodySchema = z.object({
...
export type UpdateConfigRunningCodeCommentBody = z.infer<typeof UpdateConfigRunningCodeCommentBodySchema>;

export class UpdateConfigRunningCodeCommentDto {
  @ApiPropertyOptional({
...
export class UpdateConfigRunningCodeCommentBodyDto extends createZodDto(
