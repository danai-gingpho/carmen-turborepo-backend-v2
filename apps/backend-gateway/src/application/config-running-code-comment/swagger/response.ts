...
export class ConfigRunningCodeCommentResponseDto {
  @ApiProperty({ description: 'Comment ID', example: 'a1b2c3d4-e5f6-7890-abcd-ef1234567890' }) id: string;
  @ApiProperty({ description: 'ConfigRunningCode ID', example: '123e4567-e89b-12d3-a456-426614174000' }) config_running_code_id: string;
...
export class ConfigRunningCodeCommentListResponseDto {
  @ApiProperty({ description: 'List of config-running-code comment records', type: [ConfigRunningCodeCommentResponseDto] }) data: ConfigRunningCodeCommentResponseDto[];
...
export class ConfigRunningCodeCommentMutationResponseDto {
  @ApiProperty({ description: 'ConfigRunningCode comment ID', example: 'a1b2c3d4-e5f6-7890-abcd-ef1234567890' }) id: string;
}
