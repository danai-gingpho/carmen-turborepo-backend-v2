...
export class CurrencyCommentResponseDto {
  @ApiProperty({ description: 'Comment ID', example: 'a1b2c3d4-e5f6-7890-abcd-ef1234567890' }) id: string;
  @ApiProperty({ description: 'Currency ID', example: '123e4567-e89b-12d3-a456-426614174000' }) currency_id: string;
...
export class CurrencyCommentListResponseDto {
  @ApiProperty({ description: 'List of currency comment records', type: [CurrencyCommentResponseDto] }) data: CurrencyCommentResponseDto[];
...
export class CurrencyCommentMutationResponseDto {
  @ApiProperty({ description: 'Currency comment ID', example: 'a1b2c3d4-e5f6-7890-abcd-ef1234567890' }) id: string;
}
