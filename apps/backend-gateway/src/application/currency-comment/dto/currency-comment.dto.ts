 ...
 */
export const UpdateCurrencyCommentBodySchema = z.object({
...
export type UpdateCurrencyCommentBody = z.infer<typeof UpdateCurrencyCommentBodySchema>;

export class UpdateCurrencyCommentDto {
  @ApiPropertyOptional({
...
export class UpdateCurrencyCommentBodyDto extends createZodDto(
