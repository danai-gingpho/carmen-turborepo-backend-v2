 ...
 */
export const UpdateStockOutCommentBodySchema = z.object({
...
export type UpdateStockOutCommentBody = z.infer<typeof UpdateStockOutCommentBodySchema>;

export class UpdateStockOutCommentDto {
  @ApiPropertyOptional({
...
export class UpdateStockOutCommentBodyDto extends createZodDto(
