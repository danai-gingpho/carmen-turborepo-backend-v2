 ...
 */
export const UpdateSpotCheckCommentBodySchema = z.object({
...
export type UpdateSpotCheckCommentBody = z.infer<typeof UpdateSpotCheckCommentBodySchema>;

export class UpdateSpotCheckCommentDto {
  @ApiPropertyOptional({
...
export class UpdateSpotCheckCommentBodyDto extends createZodDto(
