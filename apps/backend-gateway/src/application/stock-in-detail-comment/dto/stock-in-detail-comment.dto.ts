 ...
 */
export const UpdateStockInDetailCommentBodySchema = z.object({
...
export type UpdateStockInDetailCommentBody = z.infer<typeof UpdateStockInDetailCommentBodySchema>;

export class UpdateStockInDetailCommentDto {
  @ApiPropertyOptional({
...
export class UpdateStockInDetailCommentBodyDto extends createZodDto(
