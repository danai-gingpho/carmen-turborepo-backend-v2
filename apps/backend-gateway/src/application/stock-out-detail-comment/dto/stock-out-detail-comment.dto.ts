 ...
 */
export const UpdateStockOutDetailCommentBodySchema = z.object({
...
export type UpdateStockOutDetailCommentBody = z.infer<typeof UpdateStockOutDetailCommentBodySchema>;

export class UpdateStockOutDetailCommentDto {
  @ApiPropertyOptional({
...
export class UpdateStockOutDetailCommentBodyDto extends createZodDto(
