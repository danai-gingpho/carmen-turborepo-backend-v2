...
export class CreditNoteCommentResponseDto {
  @ApiProperty({ description: 'Comment ID', example: 'a1b2c3d4-e5f6-7890-abcd-ef1234567890' })
  id: string;
  @ApiProperty({ description: 'CreditNote ID', example: '123e4567-e89b-12d3-a456-426614174000' })
...
export class CreditNoteCommentListResponseDto {
  @ApiProperty({ description: 'List of credit-note comment records', type: [CreditNoteCommentResponseDto] })
  data: CreditNoteCommentResponseDto[];
...
export class CreditNoteCommentMutationResponseDto {
  @ApiProperty({ description: 'CreditNote comment ID', example: 'a1b2c3d4-e5f6-7890-abcd-ef1234567890' })
  id: string;
}
