 ...
 */
export const UpdateDeliveryPointCommentBodySchema = z.object({
...
export type UpdateDeliveryPointCommentBody = z.infer<typeof UpdateDeliveryPointCommentBodySchema>;

export class UpdateDeliveryPointCommentDto {
  @ApiPropertyOptional({
...
export class UpdateDeliveryPointCommentBodyDto extends createZodDto(
