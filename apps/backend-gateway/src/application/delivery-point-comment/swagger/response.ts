...
export class DeliveryPointCommentResponseDto {
  @ApiProperty({ description: 'Comment ID', example: 'a1b2c3d4-e5f6-7890-abcd-ef1234567890' }) id: string;
  @ApiProperty({ description: 'DeliveryPoint ID', example: '123e4567-e89b-12d3-a456-426614174000' }) delivery_point_id: string;
...
export class DeliveryPointCommentListResponseDto {
  @ApiProperty({ description: 'List of delivery-point comment records', type: [DeliveryPointCommentResponseDto] }) data: DeliveryPointCommentResponseDto[];
...
export class DeliveryPointCommentMutationResponseDto {
  @ApiProperty({ description: 'DeliveryPoint comment ID', example: 'a1b2c3d4-e5f6-7890-abcd-ef1234567890' }) id: string;
}
