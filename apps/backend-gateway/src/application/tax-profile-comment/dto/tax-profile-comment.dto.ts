 ...
 */
export const UpdateTaxProfileCommentBodySchema = z.object({
...
export type UpdateTaxProfileCommentBody = z.infer<typeof UpdateTaxProfileCommentBodySchema>;

export class UpdateTaxProfileCommentDto {
  @ApiPropertyOptional({
...
export class UpdateTaxProfileCommentBodyDto extends createZodDto(
