...
export class TaxProfileCommentResponseDto {
  @ApiProperty({ description: 'Comment ID', example: 'a1b2c3d4-e5f6-7890-abcd-ef1234567890' }) id: string;
  @ApiProperty({ description: 'TaxProfile ID', example: '123e4567-e89b-12d3-a456-426614174000' }) tax_profile_id: string;
...
export class TaxProfileCommentListResponseDto {
  @ApiProperty({ description: 'List of tax-profile comment records', type: [TaxProfileCommentResponseDto] }) data: TaxProfileCommentResponseDto[];
...
export class TaxProfileCommentMutationResponseDto {
  @ApiProperty({ description: 'TaxProfile comment ID', example: 'a1b2c3d4-e5f6-7890-abcd-ef1234567890' }) id: string;
}
