...
export class CreditTermCommentController {
  ...
  @Get(':bu_code/credit-term-comment/:credit_term_id')
  @UseGuards(new AppIdGuard('creditTermComment.findAll'))
  @ApiVersionMinRequest()
  @ApiUserFilterQueries()
  @ApiOperation({
    summary: 'Get all comments for a credit-term',
    operationId: 'findAllCreditTermComments',
    responses: {
  ...
  async findAllByParentId(
    ...
    @Param('credit_term_id', new ParseUUIDPipe({ version: '4' })) credit_term_id: string,
    @Req() req: Request,
    ...
    return this.creditTermCommentService.findAllByParentId(
      credit_term_id,
      user_id,
      bu_code,
      paginate,
  ...
  @ApiVersionMinRequest()
  @ApiOperation({
    summary: 'Update a credit-term comment with attachment add/remove',
    operationId: 'updateCreditTermComment',
    responses: {
  ...
  async update(
    ...
    const parsed = UpdateCreditTermCommentBodySchema.safeParse(rawBody);
    if (!parsed.success) {
    ...
    const { user_id } = ExtractRequestHeader(req);
    return this.creditTermCommentService.update(
      id,
      {
  ...
  @ApiVersionMinRequest()
  @ApiOperation({
    summary: 'Delete a credit-term comment',
    operationId: 'deleteCreditTermComment',
    responses: {
  ...
  @ApiVersionMinRequest()
  @ApiOperation({
    summary: 'Add attachments to a credit-term comment',
    operationId: 'addAttachmentsToCreditTermComment',
    responses: {
  ...
  async addAttachment(
    ...
    const { user_id } = ExtractRequestHeader(req);
    return this.creditTermCommentService.addAttachments(
      id,
      files,
      user_id,
      bu_code,
  ...
  @ApiVersionMinRequest()
  @ApiOperation({
    summary: 'Remove an attachment from a credit-term comment',
    operationId: 'removeAttachmentFromCreditTermComment',
    responses: {
  ...
  @Post(':bu_code/credit-term-comment/:credit_term_id')
  ...
  async createWithFiles(
    @Param('bu_code') bu_code: string,
    @Param('credit_term_id', new ParseUUIDPipe({ version: '4' }))
