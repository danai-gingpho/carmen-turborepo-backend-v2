 ...
 */
export const UpdateCreditTermCommentBodySchema = z.object({
...
export type UpdateCreditTermCommentBody = z.infer<typeof UpdateCreditTermCommentBodySchema>;

export class UpdateCreditTermCommentDto {
  @ApiPropertyOptional({
...
export class UpdateCreditTermCommentBodyDto extends createZodDto(
  UpdateCreditTermCommentBodySchema,
) {}
