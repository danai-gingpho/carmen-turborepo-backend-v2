...
export class CreditTermCommentResponseDto {
  @ApiProperty({ description: 'Comment ID', example: 'a1b2c3d4-e5f6-7890-abcd-ef1234567890' }) id: string;
  @ApiProperty({ description: 'CreditTerm ID', example: '123e4567-e89b-12d3-a456-426614174000' }) credit_term_id: string;
...
export class CreditTermCommentListResponseDto {
  @ApiProperty({ description: 'List of credit-term comment records', type: [CreditTermCommentResponseDto] }) data: CreditTermCommentResponseDto[];
...
export class CreditTermCommentMutationResponseDto {
  @ApiProperty({ description: 'CreditTerm comment ID', example: 'a1b2c3d4-e5f6-7890-abcd-ef1234567890' }) id: string;
}
