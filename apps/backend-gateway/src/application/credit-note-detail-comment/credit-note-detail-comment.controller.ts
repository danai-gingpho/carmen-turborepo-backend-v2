...
export class CreditNoteDetailCommentController {
  ...
  async findAllByParentId(
    ...
    return this.creditNoteDetailCommentService.findAllByParentId(
  ...
  @ApiVersionMinRequest()
  @ApiOperation({
    summary: 'Add attachments to a credit-note-detail comment',
    operationId: 'addAttachmentsToCreditNoteDetailComment',
    responses: {
