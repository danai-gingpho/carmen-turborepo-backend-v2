...
export class CreditNoteDetailCommentResponseDto {
  @ApiProperty({ description: 'Comment ID', example: 'a1b2c3d4-e5f6-7890-abcd-ef1234567890' })
  id: string;
  @ApiProperty({ description: 'CreditNoteDetail ID', example: '123e4567-e89b-12d3-a456-426614174000' })
...
export class CreditNoteDetailCommentListResponseDto {
  @ApiProperty({ description: 'List of credit-note-detail comment records', type: [CreditNoteDetailCommentResponseDto] })
  data: CreditNoteDetailCommentResponseDto[];
...
export class CreditNoteDetailCommentMutationResponseDto {
  @ApiProperty({ description: 'CreditNoteDetail comment ID', example: 'a1b2c3d4-e5f6-7890-abcd-ef1234567890' })
  id: string;
}
