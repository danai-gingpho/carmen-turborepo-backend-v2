 ...
 */
export const UpdateExchangeRateCommentBodySchema = z.object({
...
export type UpdateExchangeRateCommentBody = z.infer<typeof UpdateExchangeRateCommentBodySchema>;

export class UpdateExchangeRateCommentDto {
  @ApiPropertyOptional({
...
export class UpdateExchangeRateCommentBodyDto extends createZodDto(
