 ...
 */
export const UpdateGoodReceivedNoteDetailCommentBodySchema = z.object({
...
export type UpdateGoodReceivedNoteDetailCommentBody = z.infer<typeof UpdateGoodReceivedNoteDetailCommentBodySchema>;

export class UpdateGoodReceivedNoteDetailCommentDto {
  @ApiPropertyOptional({
...
export class UpdateGoodReceivedNoteDetailCommentBodyDto extends createZodDto(
