...
export class GoodReceivedNoteDetailCommentResponseDto {
  @ApiProperty({ description: 'Comment ID', example: 'a1b2c3d4-e5f6-7890-abcd-ef1234567890' })
  id: string;
  @ApiProperty({ description: 'GoodReceivedNoteDetail ID', example: '123e4567-e89b-12d3-a456-426614174000' })
...
export class GoodReceivedNoteDetailCommentListResponseDto {
  @ApiProperty({ description: 'List of good-received-note-detail comment records', type: [GoodReceivedNoteDetailCommentResponseDto] })
  data: GoodReceivedNoteDetailCommentResponseDto[];
...
export class GoodReceivedNoteDetailCommentMutationResponseDto {
  @ApiProperty({ description: 'GoodReceivedNoteDetail comment ID', example: 'a1b2c3d4-e5f6-7890-abcd-ef1234567890' })
  id: string;
}
