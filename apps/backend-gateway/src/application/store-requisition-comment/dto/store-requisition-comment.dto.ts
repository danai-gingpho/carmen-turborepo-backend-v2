 ...
 */
export const UpdateStoreRequisitionCommentBodySchema = z.object({
...
export type UpdateStoreRequisitionCommentBody = z.infer<typeof UpdateStoreRequisitionCommentBodySchema>;

export class UpdateStoreRequisitionCommentDto {
  @ApiPropertyOptional({
...
export class UpdateStoreRequisitionCommentBodyDto extends createZodDto(
