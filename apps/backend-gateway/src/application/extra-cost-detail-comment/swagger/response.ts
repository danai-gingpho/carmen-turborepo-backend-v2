...
export class ExtraCostDetailCommentResponseDto {
  @ApiProperty({ description: 'Comment ID', example: 'a1b2c3d4-e5f6-7890-abcd-ef1234567890' })
  id: string;
  @ApiProperty({ description: 'ExtraCostDetail ID', example: '123e4567-e89b-12d3-a456-426614174000' })
...
export class ExtraCostDetailCommentListResponseDto {
  @ApiProperty({ description: 'List of extra-cost-detail comment records', type: [ExtraCostDetailCommentResponseDto] })
  data: ExtraCostDetailCommentResponseDto[];
...
export class ExtraCostDetailCommentMutationResponseDto {
  @ApiProperty({ description: 'ExtraCostDetail comment ID', example: 'a1b2c3d4-e5f6-7890-abcd-ef1234567890' })
  id: string;
}
