 ...
 */
export const UpdateExtraCostDetailCommentBodySchema = z.object({
...
export type UpdateExtraCostDetailCommentBody = z.infer<typeof UpdateExtraCostDetailCommentBodySchema>;

export class UpdateExtraCostDetailCommentDto {
  @ApiPropertyOptional({
...
export class UpdateExtraCostDetailCommentBodyDto extends createZodDto(
  UpdateExtraCostDetailCommentBodySchema,
) {}
