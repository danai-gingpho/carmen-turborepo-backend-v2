 ...
 */
export const UpdateDepartmentCommentBodySchema = z.object({
...
export type UpdateDepartmentCommentBody = z.infer<typeof UpdateDepartmentCommentBodySchema>;

export class UpdateDepartmentCommentDto {
  @ApiPropertyOptional({
...
export class UpdateDepartmentCommentBodyDto extends createZodDto(
