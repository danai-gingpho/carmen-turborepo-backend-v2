...
export class DepartmentCommentResponseDto {
  @ApiProperty({ description: 'Comment ID', example: 'a1b2c3d4-e5f6-7890-abcd-ef1234567890' }) id: string;
  @ApiProperty({ description: 'Department ID', example: '123e4567-e89b-12d3-a456-426614174000' }) department_id: string;
...
export class DepartmentCommentListResponseDto {
  @ApiProperty({ description: 'List of department comment records', type: [DepartmentCommentResponseDto] }) data: DepartmentCommentResponseDto[];
...
export class DepartmentCommentMutationResponseDto {
  @ApiProperty({ description: 'Department comment ID', example: 'a1b2c3d4-e5f6-7890-abcd-ef1234567890' }) id: string;
}
