...
import {
  UpdateDepartmentCommentDto,
  UpdateDepartmentCommentBodySchema,
  AddAttachmentsDto,
...
export class DepartmentCommentController {
  ...
  @Get(':bu_code/department-comment/:department_id')
  @UseGuards(new AppIdGuard('departmentComment.findAll'))
  @ApiVersionMinRequest()
  @ApiUserFilterQueries()
  @ApiOperation({
    summary: 'Get all comments for a department',
    operationId: 'findAllDepartmentComments',
    responses: {
  ...
  async findAllByParentId(
    ...
    @Param('department_id', new ParseUUIDPipe({ version: '4' })) department_id: string,
    @Req() req: Request,
    ...
    return this.departmentCommentService.findAllByParentId(
      department_id,
      user_id,
      bu_code,
      paginate,
  ...
  @ApiVersionMinRequest()
  @ApiOperation({
    summary: 'Update a department comment with attachment add/remove',
    operationId: 'updateDepartmentComment',
    responses: {
  ...
  async update(
    ...
    const parsed = UpdateDepartmentCommentBodySchema.safeParse(rawBody);
    if (!parsed.success) {
    ...
    const { user_id } = ExtractRequestHeader(req);
    return this.departmentCommentService.update(
      id,
      {
  ...
  @ApiVersionMinRequest()
  @ApiOperation({
    summary: 'Delete a department comment',
    operationId: 'deleteDepartmentComment',
    responses: {
  ...
  @ApiVersionMinRequest()
  @ApiOperation({
    summary: 'Add attachments to a department comment',
    operationId: 'addAttachmentsToDepartmentComment',
    responses: {
  ...
  async addAttachment(
    ...
    const { user_id } = ExtractRequestHeader(req);
    return this.departmentCommentService.addAttachments(
      id,
      files,
      user_id,
      bu_code,
  ...
  @ApiVersionMinRequest()
  @ApiOperation({
    summary: 'Remove an attachment from a department comment',
    operationId: 'removeAttachmentFromDepartmentComment',
    responses: {
  ...
  @Post(':bu_code/department-comment/:department_id')
  ...
  async createWithFiles(
    @Param('bu_code') bu_code: string,
    @Param('department_id', new ParseUUIDPipe({ version: '4' }))
