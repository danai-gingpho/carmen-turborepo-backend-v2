 ...
 */
export const UpdatePurchaseOrderDetailCommentBodySchema = z.object({
...
export type UpdatePurchaseOrderDetailCommentBody = z.infer<typeof UpdatePurchaseOrderDetailCommentBodySchema>;

export class UpdatePurchaseOrderDetailCommentDto {
  @ApiPropertyOptional({
...
export class UpdatePurchaseOrderDetailCommentBodyDto extends createZodDto(
