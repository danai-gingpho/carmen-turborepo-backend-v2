...
export class PurchaseOrderDetailCommentResponseDto {
  @ApiProperty({ description: 'Comment ID', example: 'a1b2c3d4-e5f6-7890-abcd-ef1234567890' })
  id: string;
  @ApiProperty({ description: 'PurchaseOrderDetail ID', example: '123e4567-e89b-12d3-a456-426614174000' })
...
export class PurchaseOrderDetailCommentListResponseDto {
  @ApiProperty({ description: 'List of purchase-order-detail comment records', type: [PurchaseOrderDetailCommentResponseDto] })
  data: PurchaseOrderDetailCommentResponseDto[];
...
export class PurchaseOrderDetailCommentMutationResponseDto {
  @ApiProperty({ description: 'PurchaseOrderDetail comment ID', example: 'a1b2c3d4-e5f6-7890-abcd-ef1234567890' })
  id: string;
}
