 ...
 */
export const UpdatePurchaseOrderCommentBodySchema = z.object({
...
export type UpdatePurchaseOrderCommentBody = z.infer<typeof UpdatePurchaseOrderCommentBodySchema>;

export class UpdatePurchaseOrderCommentDto {
  @ApiPropertyOptional({
...
export class UpdatePurchaseOrderCommentBodyDto extends createZodDto(
