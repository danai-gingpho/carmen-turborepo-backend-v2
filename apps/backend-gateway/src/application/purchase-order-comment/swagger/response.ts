...
export class PurchaseOrderCommentResponseDto {
  @ApiProperty({ description: 'Comment ID', example: 'a1b2c3d4-e5f6-7890-abcd-ef1234567890' })
  id: string;
  @ApiProperty({ description: 'PurchaseOrder ID', example: '123e4567-e89b-12d3-a456-426614174000' })
...
export class PurchaseOrderCommentListResponseDto {
  @ApiProperty({ description: 'List of purchase-order comment records', type: [PurchaseOrderCommentResponseDto] })
  data: PurchaseOrderCommentResponseDto[];
...
export class PurchaseOrderCommentMutationResponseDto {
  @ApiProperty({ description: 'PurchaseOrder comment ID', example: 'a1b2c3d4-e5f6-7890-abcd-ef1234567890' })
  id: string;
}
