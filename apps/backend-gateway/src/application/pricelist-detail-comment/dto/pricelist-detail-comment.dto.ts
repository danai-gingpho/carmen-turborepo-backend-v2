 ...
 */
export const UpdatePricelistDetailCommentBodySchema = z.object({
...
export type UpdatePricelistDetailCommentBody = z.infer<typeof UpdatePricelistDetailCommentBodySchema>;

export class UpdatePricelistDetailCommentDto {
  @ApiPropertyOptional({
...
export class UpdatePricelistDetailCommentBodyDto extends createZodDto(
