...
export class PricelistDetailCommentResponseDto {
  @ApiProperty({ description: 'Comment ID', example: 'a1b2c3d4-e5f6-7890-abcd-ef1234567890' }) id: string;
  @ApiProperty({ description: 'PricelistDetail ID', example: '123e4567-e89b-12d3-a456-426614174000' }) pricelist_detail_id: string;
...
export class PricelistDetailCommentListResponseDto {
  @ApiProperty({ description: 'List of pricelist-detail comment records', type: [PricelistDetailCommentResponseDto] }) data: PricelistDetailCommentResponseDto[];
...
export class PricelistDetailCommentMutationResponseDto {
  @ApiProperty({ description: 'PricelistDetail comment ID', example: 'a1b2c3d4-e5f6-7890-abcd-ef1234567890' }) id: string;
}
