...
import {
  UpdatePricelistDetailCommentDto,
  UpdatePricelistDetailCommentBodySchema,
  AddAttachmentsDto,
...
export class PricelistDetailCommentController {
  ...
  @Get(':bu_code/pricelist-detail-comment/:pricelist_detail_id')
  @UseGuards(new AppIdGuard('pricelistDetailComment.findAll'))
  @ApiVersionMinRequest()
  @ApiUserFilterQueries()
  @ApiOperation({
    summary: 'Get all comments for a pricelist-detail',
    operationId: 'findAllPricelistDetailComments',
    responses: {
  ...
  async findAllByParentId(
    ...
    @Param('pricelist_detail_id', new ParseUUIDPipe({ version: '4' })) pricelist_detail_id: string,
    @Req() req: Request,
    ...
    return this.pricelistDetailCommentService.findAllByParentId(
      pricelist_detail_id,
      user_id,
      bu_code,
      paginate,
  ...
  @ApiVersionMinRequest()
  @ApiOperation({
    summary: 'Update a pricelist-detail comment with attachment add/remove',
    operationId: 'updatePricelistDetailComment',
    responses: {
  ...
  async update(
    ...
    const parsed = UpdatePricelistDetailCommentBodySchema.safeParse(rawBody);
    if (!parsed.success) {
    ...
    const { user_id } = ExtractRequestHeader(req);
    return this.pricelistDetailCommentService.update(
      id,
      {
  ...
  @ApiVersionMinRequest()
  @ApiOperation({
    summary: 'Delete a pricelist-detail comment',
    operationId: 'deletePricelistDetailComment',
    responses: {
  ...
  @ApiVersionMinRequest()
  @ApiOperation({
    summary: 'Add attachments to a pricelist-detail comment',
    operationId: 'addAttachmentsToPricelistDetailComment',
    responses: {
  ...
  async addAttachment(
    ...
    const { user_id } = ExtractRequestHeader(req);
    return this.pricelistDetailCommentService.addAttachments(
      id,
      files,
      user_id,
      bu_code,
  ...
  @ApiVersionMinRequest()
  @ApiOperation({
    summary: 'Remove an attachment from a pricelist-detail comment',
    operationId: 'removeAttachmentFromPricelistDetailComment',
    responses: {
  ...
  @Post(':bu_code/pricelist-detail-comment/:pricelist_detail_id')
  ...
  async createWithFiles(
    @Param('bu_code') bu_code: string,
    @Param('pricelist_detail_id', new ParseUUIDPipe({ version: '4' }))
