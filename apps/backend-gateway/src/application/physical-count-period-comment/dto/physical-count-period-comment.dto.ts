 ...
 */
export const UpdatePhysicalCountPeriodCommentBodySchema = z.object({
...
export type UpdatePhysicalCountPeriodCommentBody = z.infer<typeof UpdatePhysicalCountPeriodCommentBodySchema>;

export class UpdatePhysicalCountPeriodCommentDto {
  @ApiPropertyOptional({
...
export class UpdatePhysicalCountPeriodCommentBodyDto extends createZodDto(
