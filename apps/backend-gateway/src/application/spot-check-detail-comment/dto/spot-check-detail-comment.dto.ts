 ...
 */
export const UpdateSpotCheckDetailCommentBodySchema = z.object({
...
export type UpdateSpotCheckDetailCommentBody = z.infer<typeof UpdateSpotCheckDetailCommentBodySchema>;

export class UpdateSpotCheckDetailCommentDto {
  @ApiPropertyOptional({
...
export class UpdateSpotCheckDetailCommentBodyDto extends createZodDto(
