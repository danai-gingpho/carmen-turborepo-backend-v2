...
import {
  ...
  UpdateSpotCheckDetailCommentBodySchema,
  AddAttachmentsDto,
...
export class SpotCheckDetailCommentController {
  ...
  @Get(':bu_code/spot-check-detail-comment/:spot_check_detail_id')
  ...
  async findAllByParentId(
    ...
    return this.spotCheckDetailCommentService.findAllByParentId(
  ...
  @ApiVersionMinRequest()
  @ApiOperation({
    summary: 'Update a spot-check-detail comment with attachment add/remove',
  ...
  @ApiBody({ type: UpdateSpotCheckDetailCommentDto })
  @HttpCode(HttpStatus.OK)
  async update(
    @Param('bu_code') bu_code: string,
    ...
    const parsed = UpdateSpotCheckDetailCommentBodySchema.safeParse(rawBody);
    if (!parsed.success) {
  ...
  @ApiVersionMinRequest()
  @ApiOperation({
    summary: 'Add attachments to a spot-check-detail comment',
    operationId: 'addAttachmentsToSpotCheckDetailComment',
    responses: {
  ...
  async addAttachment(
    ...
    const { user_id } = ExtractRequestHeader(req);
    return this.spotCheckDetailCommentService.addAttachments(
      id,
      files,
      user_id,
      bu_code,
  ...
  async removeAttachment(
    ...
    const { user_id } = ExtractRequestHeader(req);
    return this.spotCheckDetailCommentService.removeAttachment(id, fileToken, user_id, bu_code, version);
  }

  @Post(':bu_code/spot-check-detail-comment/:spot_check_detail_id')
  ...
  async createWithFiles(
    @Param('bu_code') bu_code: string,
    @Param('spot_check_detail_id', new ParseUUIDPipe({ version: '4' }))
