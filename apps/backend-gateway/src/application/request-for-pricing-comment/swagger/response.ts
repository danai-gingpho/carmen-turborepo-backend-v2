...
export class RequestForPricingCommentResponseDto {
  @ApiProperty({ description: 'Comment ID', example: 'a1b2c3d4-e5f6-7890-abcd-ef1234567890' })
  id: string;
  @ApiProperty({ description: 'RequestForPricing ID', example: '123e4567-e89b-12d3-a456-426614174000' })
...
export class RequestForPricingCommentListResponseDto {
  @ApiProperty({ description: 'List of request-for-pricing comment records', type: [RequestForPricingCommentResponseDto] })
  data: RequestForPricingCommentResponseDto[];
...
export class RequestForPricingCommentMutationResponseDto {
  @ApiProperty({ description: 'RequestForPricing comment ID', example: 'a1b2c3d4-e5f6-7890-abcd-ef1234567890' })
  id: string;
}
