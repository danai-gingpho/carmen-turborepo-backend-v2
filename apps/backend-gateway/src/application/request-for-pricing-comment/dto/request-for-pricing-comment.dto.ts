 ...
 */
export const UpdateRequestForPricingCommentBodySchema = z.object({
...
export type UpdateRequestForPricingCommentBody = z.infer<typeof UpdateRequestForPricingCommentBodySchema>;

export class UpdateRequestForPricingCommentDto {
  @ApiPropertyOptional({
...
export class UpdateRequestForPricingCommentBodyDto extends createZodDto(
