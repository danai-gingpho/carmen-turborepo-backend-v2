...
export const ExchangeRateCreateItem = z.object({
  at_date: z.union([z.date(), z.string()]).nullable().optional(),
  exchange_rate: z.number().nullable().optional(),
  currency_id: z.string().uuid(),
});

export const ExchangeRateCreate = ExchangeRateCreateItem;

export const ExchangeRateCreateBulk = z.array(ExchangeRateCreateItem);

export type ICreateExchangeRate = z.infer<typeof ExchangeRateCreateItem>;
