...
export class ProductCategoryCreateDto extends createZodDto(
...
export type IUpdateProductCategory = z.infer<typeof ProductCategoryUpdate> & {
  id: string;
};
export class ProductCategoryUpdateDto extends createZodDto(
