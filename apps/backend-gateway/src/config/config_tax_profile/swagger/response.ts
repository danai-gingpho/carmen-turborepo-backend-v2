...
export class TaxProfileListResponseDto {
  @ApiProperty({ description: 'List of TaxProfile records', type: [TaxProfileResponseDto] })
...
export class TaxProfileMutationResponseDto {
  @ApiProperty({ description: 'TaxProfile ID', example: 'a1b2c3d4-e5f6-7890-abcd-ef1234567890' })
  id: string;
}
