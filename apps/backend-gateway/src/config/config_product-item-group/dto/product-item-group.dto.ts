...
export class ProductItemGroupCreateDto extends createZodDto(
  ProductItemGroupCreate,
) { }
...
export class ProductItemGroupUpdateDto extends createZodDto(
  ProductItemGroupUpdate,
) { }
