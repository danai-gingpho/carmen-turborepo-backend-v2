...
export class ProductItemGroupListResponseDto {
  @ApiProperty({ description: 'List of ProductItemGroup records', type: [ProductItemGroupResponseDto] })
  data: ProductItemGroupResponseDto[];
...
export class ProductItemGroupMutationResponseDto {
  @ApiProperty({ description: 'ProductItemGroup ID', example: 'a1b2c3d4-e5f6-7890-abcd-ef1234567890' })
  id: string;
}
