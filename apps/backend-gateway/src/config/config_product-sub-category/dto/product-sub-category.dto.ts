...
export type ICreateProductSubCategory = z.infer<
  typeof ProductSubCategoryCreate
>;

export class ProductSubCategoryCreateDto extends createZodDto(
...
export type IUpdateProductSubCategory = z.infer<
  typeof ProductSubCategoryUpdate
> & { id: string };

export class ProductSubCategoryUpdateDto extends createZodDto(
