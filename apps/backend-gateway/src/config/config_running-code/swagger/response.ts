...
export class RunningCodeListResponseDto {
  @ApiProperty({ description: 'List of RunningCode records', type: [RunningCodeResponseDto] })
  data: RunningCodeResponseDto[];
...
export class RunningCodeMutationResponseDto {
  @ApiProperty({ description: 'RunningCode ID', example: 'a1b2c3d4-e5f6-7890-abcd-ef1234567890' })
  id: string;
}
