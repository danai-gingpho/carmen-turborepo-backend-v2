...
SYSTEM_DIRECT_URL=postgresql://developer:123456@dev.blueledgers.com:6432?schema=CARMEN_SYSTEM" > .env.production & dotenvx run --env-file=.env.production -- bun run db:deploy
