...
if [ ! -f /etc/nginx/ssl/carmen-api.crt ]; then
    ...
    sudo openssl req -x509 -nodes -days 365 -newkey rsa:2048 \
        ...
        -subj "/C=AU/ST=NSW/L=Sydney/O=Carmen/CN=ec2-3-25-162-252.ap-southeast-2.compute.amazonaws.com"
fi
...
echo "  http://ec2-3-25-162-252.ap-southeast-2.compute.amazonaws.com"
echo "  https://ec2-3-25-162-252.ap-southeast-2.compute.amazonaws.com"
echo ""
